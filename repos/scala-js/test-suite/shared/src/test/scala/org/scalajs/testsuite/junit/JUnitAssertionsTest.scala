...
class JUnitAssertionsTest {
  ...
  def testAssertTrueFalse(): Unit = {
    ...
    testIfAsserts(assertFalse("'false' did not assertFalse", true),
                  ShallNotPass)
  ...
  def testAssertNull(): Unit = {
    ...
    testIfAsserts(assertNull("'null' did not assertNull", new Object),
                  ShallNotPass)
    testIfAsserts(assertNull(new Object), ShallNotPass)

    testIfAsserts(assertNotNull("'null' did not assertNotNull", null),
                  ShallNotPass)
  ...
  def testAssertSame(): Unit = {
    ...
    def testAssertion(expected: AnyRef,
                      actual: AnyRef,
                      equals: Boolean = true): Unit = {
      testIfAsserts(assertSame("References where not equal", expected, actual),
                    equals)
      testIfAsserts(assertSame(expected, actual), equals)
      testIfAsserts(assertNotSame("References where equal", expected, actual),
                    !equals)
  ...
  def testAssertEqualsByte(): Unit = {
    def testByteAssertion(expected: Byte,
                          actual: Byte,
                          equals: Boolean = true): Unit = {
      testIfAsserts(
          assertEquals(s"Asserting $expected == $actual", expected, actual),
  ...
  def testAssertEqualsChar(): Unit = {
    def testCharAssertion(expected: Char,
                          actual: Char,
                          equals: Boolean = true): Unit = {
      testIfAsserts(
          assertEquals(s"Asserting $expected == $actual", expected, actual),
  ...
  def testAssertEqualsShort(): Unit = {
    def testShortAssertion(expected: Short,
                           actual: Short,
                           equals: Boolean = true): Unit = {
      testIfAsserts(
          assertEquals(s"Asserting $expected == $actual", expected, actual),
  ...
  def testAssertEqualsInt(): Unit = {
    def testIntAssertion(expected: Int,
                         actual: Int,
                         equals: Boolean = true): Unit = {
      testIfAsserts(
          assertEquals(s"Asserting $expected == $actual", expected, actual),
  ...
  def testAssertEqualsLong(): Unit = {
    def testLongAssertion(expected: Long,
                          actual: Long,
                          equals: Boolean = true): Unit = {
      testIfAsserts(
          assertEquals(s"Asserting $expected == $actual", expected, actual),
  ...
  def testAssertEqualsDouble(): Unit = {
    def testDoubleAssertion(expected: Double,
                            ...
                            delta: Double,
                            equals: Boolean = true): Unit = {
      testIfAsserts(assertEquals(s"Asserting $expected == $actual",
                                 expected,
                                 actual,
                                 delta),
                    equals)
      testIfAsserts(assertEquals(expected, actual, delta), equals)
      testIfAsserts(assertNotEquals(s"Asserting $expected != $actual",
                                    expected,
                                    actual,
                                    delta),
                    !equals)
...
//    testDoubleAssertion(Double.NegativeInfinity, Double.NegativeInfinity, 1.0d)
  ...
  def testAssertArrayEquals(): Unit = {
    ...
    testAnyRefAssertion(Array(obj1, obj2, obj2),
  ...
  def testAssertArrayEqualsDouble(): Unit = {
    def testDoubleAssertion(expected: Array[Double],
                            ...
                            equals: Boolean = true): Unit = {
      val message = "Should be different up to != operator"
      testIfAsserts(assertArrayEquals(message, expected, actual, delta),
                    equals)
    ...
    testDoubleAssertion(Array(1d, 2d, 3d),
                        Array(1d, 2d, 3.5d),
                        0.1d,
                        NotEquals)
    testDoubleAssertion(Array(1d, 2d, 3d),
  ...
  def testAssertArrayEqualsFloats(): Unit = {
    ...
    testFloatAssertion(Array(1f, 2f, 3f),
                       Array(1f, 2f, 3.5f),
                       0.11f,
                       NotEquals)
  }
