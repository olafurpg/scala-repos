...
class RuntimeLongTest {
  ...
  @Test def shift_left_<<(): Unit = {
    ...
    assertEquals(lg(-58458112, -1619174179),
    ...
    assertEquals(lg(1888485376, 630678170),
    ...
    assertEquals(lg(0, -1073741824),
                 lg(-1246065172, -1572087360) << 1493241980)
    assertEquals(lg(1156516188, -1812425640),
                 lg(578258094, -906212820) << 2074806145)
    assertEquals(lg(0, 1370357760), lg(61151968, -1770168701) << -2062208020)
    assertEquals(lg(-402653184, 1642287002),
                 lg(1013576541, 460756940) << -902835237)
    assertEquals(lg(-1744830464, 1690731362),
                 lg(-1731171245, 771836652) << 868975579)
    assertEquals(lg(-417260032, 563566725),
                 lg(1123258511, 1049676716) << 575477257)
    assertEquals(lg(411626816, -1915897795),
  ...
  @Test def shift_logical_right_>>>(): Unit = {
    ...
    assertEquals(lg(-1589724844, 2),
                 lg(-2071249600, 1411897130) >>> 1015183069)
    assertEquals(lg(827423626, 419765),
                 lg(-1560865755, 214919778) >>> 1191603401)
    assertEquals(lg(376475826, 25773988),
                 lg(944265510, -995896821) >>> 485744647)
    assertEquals(lg(291969293, 528),
                 lg(1131824263, -2080089658) >>> -386336938)
    ...
    assertEquals(lg(-684574597, 28915),
    ...
    assertEquals(lg(-152492078, 258),
                 lg(-384174131, -2122615661) >>> -1278414057)
    assertEquals(lg(-1650335224, 9146646),
    ...
    assertEquals(lg(868056695, -1200391723),
  ...
  @Test def shift_arithmetic_right_>>(): Unit = {
    assertEquals(lg(144041519, 2813487),
    ...
    assertEquals(lg(-587262921, -3246345),
                 lg(-30904807, -1662128199) >> -638486135)
    assertEquals(lg(-10706, -1), lg(1812122560, -701571284) >> 611632432)
    assertEquals(lg(7484398, 100362842),
                 lg(119750375, 1605805472) >> 244039684)
    ...
    assertEquals(lg(-669931160, -697),
                 lg(756433442, -1459944907) >> -775565931)
    assertEquals(lg(933146972, -1), lg(1678061064, -1680910162) >> -531660641)
    assertEquals(lg(1601141595, 1298147),
                 lg(1870355258, 332325727) >> -434372344)
    assertEquals(lg(-1047936567, -129548),
    ...
    assertEquals(lg(-1582088844, -23862710),
    ...
    assertEquals(lg(-1472236443, 19900875),
    ...
    assertEquals(lg(-868447412, 13901269),
    ...
    assertEquals(lg(1021967080, -2560),
                 lg(-341778503, -671026265) >> 532386578)
    assertEquals(lg(-1683940185, 34921),
                 lg(-1907127360, 1144311248) >> -2131012273)
    assertEquals(lg(-121723, -1), lg(756366897, -1994294687) >> -1642432978)
    assertEquals(lg(-644688038, 9473),
    ...
    assertEquals(lg(-2101780246, 11998),
  ...
  @Test def plus_+(): Unit = {
    ...
    assertEquals(lg(1031291620, 108684756),
  ...
  @Test def minus_-(): Unit = {
    ...
    assertEquals(lg(459412414, 466142261),
    ...
    assertEquals(lg(408960051, 967789979),
  ...
  @Test def times_*(): Unit = {
    ...
    assertEquals(lg(-1886196376, -31345953),
  ...
  @Test def divide_/(): Unit = {
    ...
    assertEquals(lg(0, 0),
                 lg(-857819626, 204588) / lg(-1909684886, -709519130))
    ...
    // big / int32
    assertEquals(lg(422668131, 6),
                 lg(-1495113094, 168518701) / lg(27633219, 0))
    assertEquals(lg(932715295, 204683),
                 lg(-1211847018, -609137255) / lg(-2976, -1))
    assertEquals(lg(189814434, 0),
                 lg(-457166837, -15040808) / lg(-340331202, -1))
    assertEquals(lg(-1116045071, -1131771),
                 lg(-104570473, -117704108) / lg(104, 0))
    assertEquals(lg(-784306379, 14408),
                 lg(453828098, -10187034) / lg(-707, -1))
    assertEquals(lg(-284027201, 2002401),
                 lg(1911518920, 168201762) / lg(84, 0))
    assertEquals(lg(-862273257, -2),
                 lg(610589058, 36481453) / lg(-30381877, -1))
    assertEquals(lg(-761280647, -71),
    ...
    assertEquals(lg(-137450, -1),
                 lg(-1910257093, -16610962) / lg(-640594227, 120))
    assertEquals(lg(114592, 0),
                 lg(1080864951, 17606069) / lg(-1542196664, 153))
    assertEquals(lg(61, 0), lg(-1419644278, 13937517) / lg(-919779905, 227700))
    assertEquals(lg(-247360, -1),
    ...
    assertEquals(lg(-997, -1),
                 lg(-1003647481, -7808320) / lg(-228453385, 7826))
    assertEquals(lg(36, 0), lg(-875689390, 4467236) / lg(-590010750, 120938))
    assertEquals(lg(56005, 0),
                 lg(1189085620, 611543209) / lg(1619962756, 10919))
    assertEquals(lg(-90057, -1),
    ...
    assertEquals(lg(2145, 0),
                 lg(-361322518, 63967358) / lg(-1922353888, 29810))
    assertEquals(lg(106042, 0), lg(-1774479550, 43276853) / lg(472456506, 408))
    assertEquals(lg(-381407, -1),
                 lg(-1756338345, -38928780) / lg(283612141, 102))
    assertEquals(lg(1217514, 0),
                 lg(-495049835, 37161263) / lg(-2052025512, 30))
    assertEquals(lg(-17, -1),
                 lg(1606509747, -10876159) / lg(1068727249, 635715))
    assertEquals(lg(4880327, 0),
                 lg(-1857686692, 1918485655) / lg(454913535, 393))
    assertEquals(lg(-1023070, -1),
  ...
  @Test def modulo_%(): Unit = {
    ...
    assertEquals(lg(-232837834, 5049),
    ...
    assertEquals(lg(-2004547354, 47),
                 lg(1436404594, 1595) % lg(1522987410, 70))
    ...
    assertEquals(lg(581185953, 1),
                 lg(419719197, 661188517) % lg(2112360098, 1))
    assertEquals(lg(-1880704128, 171407),
                 lg(1092830824, 1600823129) % lg(-1827462760, 172800))
    assertEquals(lg(1210159480, -13),
                 lg(-836779994, -27475595) % lg(-417527207, 16))
    assertEquals(lg(807846066, 1),
                 lg(-1759597755, 9157722) % lg(-987185779, 1))
    assertEquals(lg(949995673, 1),
                 lg(-1097231525, 20092165) % lg(1106421078, 1))
    assertEquals(lg(-712450167, 7),
                 lg(390678483, 3835040) % lg(1221250555, 14))
    assertEquals(lg(1129531033, -4),
                 lg(-284334384, -18425278) % lg(-1111448031, 6))
    assertEquals(lg(2094997010, 3022),
    ...
    assertEquals(lg(2127427912, 6),
                 lg(208769744, 280071599) % lg(-325433064, 14))
    assertEquals(lg(-722136158, -1),
                 lg(-1527711901, -51564742) % lg(-1019145455, 0))
    assertEquals(lg(-1603688570, -2),
