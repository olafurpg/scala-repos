...
object Trees {
  ...
  case class Select(qualifier: Tree,
                    item: Ident)(val tpe: Type)(implicit val pos: Position)
      extends Tree
  ...
  case class ArraySelect(array: Tree, index: Tree)(
      val tpe: Type)(implicit val pos: Position)
      extends Tree
  ...
  object CallHelper {
    def apply(helper: String,
              args: Tree*)(tpe: Type)(implicit pos: Position): CallHelper = {
  ...
  case class ClassDef(name: Ident,
                      ...
                      defs: List[Tree])(
      val optimizerHints: OptimizerHints)(implicit val pos: Position)
      extends Tree {
    val tpe = NoType
  }
  ...
  case class MethodDef(
      ...
      args: List[ParamDef],
      resultType: Type,
      body: Tree)(val optimizerHints: OptimizerHints,
