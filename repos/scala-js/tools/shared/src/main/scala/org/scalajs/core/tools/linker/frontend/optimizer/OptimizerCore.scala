                  ...
                  (tthenp, telsep) match {
                    ...
                    case (PreTransRecordTree(thenTree,
                      ...
                      cont(PreTransRecordTree(
                              If(newCond,
                                 thenTree,
                                 finishTransformExpr(telsep))(thenTree.tpe),
                              thenOrigType,
                              thenCancelFun))
        ...
        pretransformExprs(captureValues) { tcaptureValues =>
          tryOrRollback { cancelFun =>
            ...
            withNewLocalDefs(captureBindings) { (captureLocalDefs, cont1) =>
              val replacement =
                TentativeClosureReplacement(captureParams,
                                            params,
                                            body,
                                            captureLocalDefs,
                                            alreadyUsed =
                                              newSimpleState(false),
                                            cancelFun)
    ...
    stats match {
      ...
      case If(cond, th: Throw, Assign(Select(This(), _), value)) :: rest =>
        ...
        inlineClassConstructorBodyList(
            ...
            cls,
            Assign(lhs,
                   If(cond, th, value)(lhs.tpe)(stat.pos))(ass.pos) :: rest,
            cancelFun)(buildInner)(cont)
            ...
            staticCall(LongImpl.RuntimeLongClass, LongImpl.hi).fold[Tree] {
              ...
              trampoline {
                ...
                inline(Nil,
                       ...
                       isStat = false,
                       usePreTransform =
                         false)(finishTransform(isStat = false))
              }
            }
