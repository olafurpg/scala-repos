...
class HListTests {
  ...
  trait M[T]
  type MIMSMIMIMD =
    M[Int] :: M[String] :: M[Int] :: M[Int] :: M[Double] :: HNil
  ...
  object selectAll extends SingletonProductArgs {
    class Apply[K <: HList] {
      def from[T, R <: HList, S <: HList, Out](
          t: T)(implicit gen: LabelledGeneric.Aux[T, R],
