...
object tuple {
  ...
  object Last {
    ...
    implicit def last[T, L <: HList](implicit gen: Generic.Aux[T, L],
  ...
  object ReverseSplit {
    ...
    implicit def tupleReverseSplit[T,
                                   L <: HList,
                                   N <: Nat,
                                   LP <: HList,
                                   LS <: HList](
  ...
  object ReverseSplitLeft {
    ...
    implicit def tupleReverseSplitLeft[T,
                                       L <: HList,
                                       U,
                                       LP <: HList,
                                       LS <: HList](
  ...
  object ReverseSplitRight {
    ...
    implicit def tupleReverseSplitRight[T,
                                        L <: HList,
                                        U,
                                        LP <: HList,
                                        LS <: HList](
  ...
  object ConstMapper {
    def apply[T, C](
        implicit mapper: ConstMapper[T, C]): Aux[T, C, mapper.Out] = mapper
  ...
  object ToSum {
    ...
    implicit def hlistToSum[T, L <: HList](implicit gen: Generic.Aux[T, L],
