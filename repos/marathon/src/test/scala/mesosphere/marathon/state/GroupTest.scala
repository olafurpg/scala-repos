  ...
  describe("A Group") {
          ...
          groups = Set(Group(
            ...
            groups = Set(
              ...
              Group(
                ...
                Set(AppDefinition("/test/group2/app2".toPath)),
                Set(
                  Group("/test/group2/a".toPath,
                        Set(AppDefinition("/test/group2/a/app1".toPath))),
                  Group("/test/group2/b".toPath,
    ...
    it("cannot replace a group with apps by an app definition") {
      ...
      val current = Group.empty
        .makeGroup("/some/nested/path".toPath)
        .makeGroup("/some/nested/path2".toPath)
        .updateApp("/some/nested/path2/app".toPath,
                   _ =>
                     AppDefinition("/some/nested/path2/app".toPath,
                                   cmd = Some("true")),
                   Timestamp.now())
      ...
      val current = Group.empty.copy(
        groups = Set(Group(
          ...
          groups = Set(
            Group("/test/group1".toPath,
                  Set(
                    AppDefinition("/test/group1/app1".toPath,
                                  args = Some(Seq("a", "b", "c")),
                                  versionInfo = fullVersion)
                  )),
            Group("/test/group2".toPath,
                  Set(
                    AppDefinition("/test/group2/app2".toPath,
                                  args = Some(Seq("a", "b")),
                                  versionInfo = fullVersion)
                  ))
          )
        ...
        groups = Set(Group(
          ...
          groups = Set(
            Group(
              ...
              groups = Set(
                Group("/test/database/redis".toPath,
                ...
                Group(
                  ...
                  dependencies = Set("/test/database/mongo".toPath,
                                     "/test/database/redis".toPath)
                ),
                Group("/test/database/mongo".toPath,
            ...
            Group(
              "/test/service".toPath,
              groups = Set(
                Group("/test/service/service1".toPath,
            ...
            Group(
              ...
              groups = Set(
                Group("/test/frontend/app1".toPath,
            ...
            Group("/test/cache".toPath,
                  groups = Set(
                    Group("/test/cache/c1".toPath,
              ...
              groups = Set(
                Group(
                  ...
                  Set(
                    ...
                    AppDefinition("/test/database/memcache".toPath,
                                  dependencies =
                                    Set("/test/database/mongo".toPath,
                                        "/test/database/redis".toPath)),
                    AppDefinition("/test/database/mongo".toPath,
                                  dependencies =
                                    Set("/test/database/redis".toPath))
                  )
                ),
                Group(
                  "/test/service".toPath,
                  Set(
                    AppDefinition("/test/service/srv1".toPath,
                                  dependencies =
                                    Set("/test/database/memcache".toPath)),
                    AppDefinition("/test/service/srv2".toPath,
                                  dependencies =
                                    Set("/test/database/mongo".toPath,
                ...
                Group(
                  "/test/frontend".toPath,
                  Set(
                    AppDefinition("/test/frontend/app1".toPath,
                                  dependencies =
                                    Set("/test/service/srv2".toPath)),
                    AppDefinition("/test/frontend/app2".toPath,
                                  dependencies =
                                    Set("/test/service/srv2".toPath,
                                        "/test/database/mongo".toPath,
                                        "/test/frontend/app1".toPath))
          ...
          groups = Set(
            Group(
              ...
              groups = Set(
                Group("/test/database/redis".toPath,
                      Set(AppDefinition("/test/database/redis/r1".toPath))),
                Group("/test/database/memcache".toPath,
            ...
            Group(
              ...
              groups = Set(
                ...
                Group("/test/service/service2".toPath,
            ...
            Group(
              ...
              groups = Set(
                Group("/test/frontend/app1".toPath,
                      Set(AppDefinition("/test/frontend/app1/a1".toPath))),
                Group("/test/frontend/app2".toPath,
                      Set(AppDefinition("/test/frontend/app2/a2".toPath)))
              )
            ),
            Group("/test/cache".toPath,
          ...
          Group(
            ...
            groups =
              Set(
                Group("/test/service/service1".toPath,
                      Set(
                        AppDefinition("/test/service/service1/srv1".toPath,
                                      dependencies =
                                        Set("/test/database".toPath))))
              )
          )
        )
      )
      ...
      val reference: Group = Group(
        ...
        groups = Set(
          Group(
            "/test".toPath,
            groups = Set(
              Group("/test/service".toPath,
                    groups = Set(
                      Group("/test/service/test".toPath,
                            Set(AppDefinition("/test/service/test/app".toPath,
                                              cmd = Some("Foobar"))))
                    ))
            )
          )
