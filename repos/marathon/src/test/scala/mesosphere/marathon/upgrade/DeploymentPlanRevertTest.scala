...
class DeploymentPlanRevertTest
  ...
  /**
    ...
    */
  private def assertEqualsExceptVersion(expectedOrig: Group,
  ...
  private[this] def testWithConcurrentChange(originalBeforeChanges: Group,
                                             changesBeforeTest: Deployment*)(
