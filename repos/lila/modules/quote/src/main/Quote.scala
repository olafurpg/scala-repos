...
object Quote {
  ...
  val all = Vector(
      ...
      new Quote("Discovered check is the dive bomber of the chessboard.",
                "Reuben Fine"),
      new Quote("I know people who have all the will in the world, but still can’t play good chess.",
                "Bobby Fischer"),
      new Quote("A chess game is a dialogue, a conversation between a player and his opponent. Each move by the opponent may contain threats or be a blunder, but a player cannot defend against threats or take advantage of blunders if he does not first ask himself: What is my opponent planning after each move?",
                "Bruce A. Moon"),
      ...
      new Quote("In a gambit you give up a pawn for the sake of getting a lost game.",
      ...
      new Quote("Some sacrifices are sound; the rest are mine.",
                "Mikhail Tal"),
      ...
      new Quote("Morphy was probably the greatest genius of them all.",
                "Bobby Fischer"),
      new Quote("My opponents make good moves too. Sometimes I don’t take these things into consideration.",
                "Bobby Fischer"),
      ...
      new Quote(
          ...
          "Vladimir Nabokov"),
      new Quote("Personally, I rather look forward to a computer program winning the world chess Championship. Humanity needs a lesson in humility.",
                "Richard Dawkings"),
      new Quote(
      ...
      new Quote("As one by one I mowed them down, my superiority soon became apparent.",
                "Jose Capablanca"),
      new Quote("Though most people love to look at the games of the great attacking masters, some of the most successful players in history have been the quiet positional players. They slowly grind you down by taking away your space, tying up your pieces, and leaving you with virtually nothing to do!",
                "Yasser Seirawan"),
      ...
      new Quote(
          ...
          "Benjamin Franklin"),
      new Quote("Winning isn’t everything... but losing is nothing.",
                "Mednis"),
      ...
      new Quote("Chess is a terrible game. If you have no center, your opponent has a freer position. If you do have a center, then you really have something to worry about!",
                "Siegbert Tarrasch"),
      new Quote("Any material change in a position must come about by mate, a capture, or a pawn promotion.",
                "Purdy"),
      new Quote(
      ...
      new Quote("I believe that chess possesses a magic that is also a help in advanced age. A rheumatic knee is forgotten during a game of chess and other events can seem quite unimportant in comparison with a catastrophe on the chessboard.",
                "Vlastimil Hort"),
      ...
      new Quote(
          ...
          "Mikhail Botvinnik"),
      new Quote("If your opponent cannot do anything active, then don’t rush the position; instead you should let him sit there, suffer, and beg you for a draw.",
                "Jeremy Silman"),
      ...
      new Quote(
          ...
          "Mikhail Tal"),
      new Quote("I feel as if I were a piece in a game of chess, when my opponent says of it: That piece cannot be moved.",
                "Soren Kierkegaard"),
      new Quote("When your house is on fire, you cant be bothered with the neighbors.  Or, as we say in chess, if your king is under attack you don’t worry about losing a pawn on the queen’s side.",
                "Garry Kasparov"),
      new Quote(
      ...
      new Quote("The isolated pawn casts gloom over the entire chessboard.",
                "Aaron Nimzovich"),
      new Quote("For me, chess is life and every game is like a new life. Every chess player gets to live many lives in one lifetime.",
                "Eduard Gufeld"),
      new Quote(
          "Chess is a terrific way for kids to build self image and self esteem.",
          "Saudin Robovic"),
      new Quote("If a ruler does not understand chess, how can he rule over a kingdom?",
                "King Khusros II"),
      new Quote("Chess is a cold bath for the mind.", "Sir John Simon"),
      new Quote("Becoming successful at chess allows you to discover your own personality. That’s what I want for the kids I teach.",
                "Saudin Robovic"),
      ...
      new Quote(
          ...
          "William Steinitz"),
      new Quote("When I have white, I win because I am white; When I have black, I win because I am Bogolyubov.",
                "Bogolyubov"),
      ...
      new Quote(
          ...
          "Charles Buxton"),
      new Quote("Chess is a part of culture and if a culture is declining then chess too will decline.",
                "Mikhail Botvinnik"),
      ...
      new Quote(
          ...
          "H. E. Bird"),
      new Quote("I have never in my life played the French Defence, which is the dullest of all openings.",
                "Wilhelm Steinitz"),
      new Quote(
      ...
      new Quote("Those who say they understand chess, understand nothing.",
                "Robert Hubner"),
      new Quote("Good offense and good defense both begin with good development.",
                "Bruce A. Moon"),
      ...
      new Quote("The sign of a great master is his ability to win a won game quickly and painlessly.",
                "Irving Chernev"),
      new Quote(
      ...
      new Quote("You need not play well - just help your opponent to play badly.",
                "Genrikh Chepukaitis"),
      new Quote(
      ...
      new Quote(
          ...
          "Lodewijk Prins"),
      new Quote("Bobby just drops the pieces and they fall on the right squares.",
                "Miguel Najdorf"),
      new Quote(
      ...
      new Quote(
          ...
          "Albert Einstein"),
      new Quote("Nowadays, when you’re not a Grandmaster at 14, you can forget about it.",
                "Anand Viswanathan"),
      ...
      new Quote("It is always better to sacrifice your opponent’s men.",
                "Savielly Tartakower"),
      new Quote("In chess, as it is played by masters, chance is practically eliminated.",
                "Emanuel Lasker"),
      new Quote(
      ...
      new Quote("Dazzling combinations are for the many, shifting wood is for the few.",
                "Georg Kieninger"),
      new Quote(
      ...
      new Quote("Bobby Fischer’s current state of mind is indeed a tragedy. One of the worlds greatest chess players - the pride and sorrow of American chess.",
                "Frank Brady"),
      new Quote("Fischer is an American chess tragedy on par with Morphy and Pillsbury.",
                "Mig Greengard"),
      new Quote("Nonsense was the last thing Fischer was interested in, as far as chess was concerned.",
                "Elie Agur"),
      new Quote("Fischer is the strongest player in the world. In fact, the strongest player who ever lived.",
                "Larry Evans"),
      new Quote(
      ...
      new Quote(
          ...
          "Paul Kollar"),
      new Quote("Fischer chess play was always razor-sharp, rational and brilliant. One of the best ever.",
                "Dave Regis"),
      new Quote(
      ...
      new Quote("Bobby is the most misunderstood, misquoted celebrity walking the face of this earth.",
                "Yasser Seirawan"),
      new Quote("When you don’t know what to play, wait for an idea to come into your opponent’s mind. You may be sure that idea will be wrong.",
                "Siegbert Tarrasch"),
      ...
      new Quote("Bobby is the finest chess player this country ever produced. His memory for the moves, his brilliance in dreaming up combinations, and his fierce determination to win are uncanny.",
                "John Collins"),
      new Quote("After a bad opening, there is hope for the middle game. After a bad middle game, there is hope for the endgame. But once you are in the endgame, the moment of truth has arrived.",
                "Edmar Mednis"),
      new Quote("Weak points or holes in the opponent’s position must be occupied by pieces not pawns.",
                "Siegbert Tarrasch"),
      new Quote("There is only one thing Fischer does in chess without pleasure: to lose!",
                "Boris Spassky"),
      ...
      new Quote(
          ...
          "Siegbert Tarrasch"),
      new Quote("Not only will I predict his triumph over Botvinnik, but I’ll go further and say that he’ll probably be the greatest chess player that ever lived.",
                "John Collins"),
      ...
      new Quote("There’s never before been a chess player with such a thorough knowledge of the intricacies of the game and such an absolutely indomitable will to win. I think Bobby is the greatest player that ever lived.",
                "Lisa Lane"),
      new Quote("He who takes the queen’s Knight’s pawn will sleep in the streets.",
                "Anonymous"),
      ...
      new Quote("Most of the gods throw dice but Fate plays chess, and you don't find out until too late that he's been using two queens all along.",
                "Terry Pratchett"),
      new Quote("Atomic is just like regular chess, except you're exploding, everything's exploding, and you're in bullet hell.",
                "Unihedron 0"),
      ...
      new Quote("A chess player never has a heart attack in a good position.",
                "Bent Larsen"),
      new Quote("A computer beat me in chess, but it was no match when it came to kickboxing.",
                "Emo Phillips"),
      ...
      new Quote(
          ...
          "Bent Larsen"),
      new Quote("A gambit never becomes sheer routine as long as you fear you may lose the king and pawn ending!",
                "Bent Larsen"),
      ...
      new Quote(
          ...
          "Gregor Piatigorsky"),
      new Quote("A pawn, when separated from his fellows, will seldom or never make a fortune.",
                "Francois-Andre Danican Philidor"),
      ...
      new Quote(
          ...
          "Paul Keres"),
      new Quote("A real sacrifice involves a radical change in the character of a game which cannot be effected without foresight, fantasy, and the willingness to risk.",
                "Leonid Shamkovich"),
      ...
      new Quote("After a great deal of discussion in Soviet literature about the correct definition of a combination, it was decided that from the point of view of a methodical approach it was best to settle on this definition - A combination is a forced variation with a sacrifice.",
                "Alexander Kotov"),
      new Quote("Agreeing to draws in the middlegame, equal or otherwise, deprives you of the opportunity to practice playing endgames, and the endgame is probably where you need the most practice.",
                "Pal Benko"),
      new Quote(
          ...
          "Bent Larsen"),
      new Quote("All chess players know what a combination is. Whether one makes it oneself, or is its victim, or reads of it, it stands out from the rest of the game and stirs one's admiration.",
      ...
      new Quote(
          ...
          "Mikhail Botvinnik"),
      new Quote("Althought the Knight is generally considered to be on a par with the Bishop in strength, the latter piece is somehat stronger in the majority of cases in which they are opposed to each other.",
                "Jose Capablanca"),
      new Quote(
      ...
      new Quote(
          ...
          "Bent Larsen"),
      new Quote("An amusing fact: as far as I can recall, when playing the Ruy Lopez I have not yet once in my life had to face the Marshall Attack!",
                "Anatoly Karpov"),
      ...
      new Quote(
          ...
          "Levon Aronian"),
      new Quote("As a rule, pawn endings have a forced character, and they can be worked out conclusively.",
                "Mark Dvoretsky"),
      new Quote(
      ...
      new Quote("As long as my opponent has not yet castled, on each move I seek a pretext for an offensive. Even when I realize that the king is not in danger.",
                "Mikhail Tal"),
      new Quote("As often as not, his strategy consists of stifling Black's activity and then winning in an endgame thanks to his superior pawn structure.",
                "Neil McDonald (1998)"),
      ...
      new Quote("But alas! Like many another consummation devoutly to be wished, the actual performance was a disappointing one. (on the long awaited Lasker-Capablanca match in 1921)",
                "Fred Reinfeld"),
      new Quote("But how difficult it can be to gain the desired full point against an opponent of inferior strength, when this is demanded by the tournament position!",
                "Anatoly Karpov"),
      ...
      new Quote("By the mid-1990s the number of people with some experience of using computers was many orders of magnitude greater than in the 1960s. In the Kasparov defeat they recognized that here was a great triumph for programmers, but not one that may compete with the human intelligence that helps us to lead our lives.",
                "Igor Aleksander"),
      new Quote("By the time a player becomes a Grandmaster, almost all of his training time is dedicated to work on this first phase. The opening is the only phase that holds out the potential for true creativity and doing something entirely new.",
                "Garry Kasparov"),
      new Quote("By what right does White, in an absolutely even position, such as after move one, when both sides have advanced 1. e4, sacrifice a pawn, whose recapture is quite uncertain, and open up his kingside to attack? And then follow up this policy by leaving the check of the black queen open? None whatever !",
                "Emanuel Lasker"),
      ...
      new Quote(
          ...
          "Garry Kasparov"),
      new Quote("Chess is a bond of brotherhood amongst all lovers of the noble game, as perfect as free masonry. It is a leveller of rank - title, wealth, nationality, politics, religion - all are forgotten across the board.",
                "Frederick Milne Edge"),
      new Quote("Chess is a contest between two men which lends itself particularly to the conflicts surrounding aggression.",
                "Rueben Fine"),
      new Quote(
      ...
      new Quote(
          ...
          "Voltaire"),
      new Quote("Chess is a great game. No matter how good one is, there is always somebody better. No matter how bad one is, there is always somebody worse.",
                "I.A. Horowitz"),
      new Quote("Chess is a matter of delicate judgement, knowing when to punch and how to duck.",
                "Bobby Fischer"),
      ...
      new Quote("Chess is far too complex to be definitively solved with any technology we can conceive of today. However, our looked-down-upon cousin, checkers, or draughts, suffered this fate quite recently thanks to the work of Jonathan Schaeffer at the University of Alberta and his unbeatable program Chinook.",
                "Garry Kasparov"),
      new Quote("Chess is infinite, and one has to make only one ill-considered move, and one`s opponent`s wildest dreams will become reality.",
                "David Bronstein"),
      new Quote("Chess is like a language, the top players are very fluent at it. Talent can be developed scientifically but you have to find first what you are good at.",
                "Viswanathan Anand"),
      new Quote(
      ...
      new Quote("Chess is only a recreation and not an occupation.",
                "Vladimir Lenin"),
      new Quote("Chess is something more than a game. It is an intellectual diversion which has certain artistic qualities and many scientific elements.",
                "Jose Capablanca"),
      ...
      new Quote("Chess programs are our enemies, they destroy the romance of chess. They take away the beauty of the game. Everything can be calculated.",
                "Levon Aronian"),
      new Quote("Chess strategy as such today is still in its diapers, despite Tarrasch's statement 'We live today in a beautiful time of progress in all fields'. Not even the slightest attempt has been made to explore and formulate the laws of chess strategy.",
                "Aaron Nimzowitsch (1925)"),
      new Quote("Chess strength in general and chess strength in a specific match are by no means one and the same thing.",
                "Garry Kasparov"),
      new Quote("Chess will always be in the doldrums as a spectator sport while a draw is given equal mathematical value as a decisive result.",
                "Michael Basman"),
      new Quote("Chess, like love, is infectious at any age.", "Salo Flohr"),
      new Quote("Chess-play is a good and witty exercise of the mind for some kind of men, but if it proceed from overmuch study, in such a case it may do more harm than good; it is a game too troublesome for some men's brains.",
      ...
      new Quote(
          ...
          "Viswanathan Anand"),
      new Quote("Contrary to many young colleagues I do believe that it makes sense to study the classics.",
                "Magnus Carlsen"),
      new Quote(
          ...
          "Frederick Milne Edge"),
      new Quote("Despite the development of chess theory, there is much that remains secret and unexplored in chess.",
                "Vasily Smyslov"),
      new Quote("Do not bring your Queen out too early.",
                "from Francisco Bernardina Calogno's poem 'On the Game of Chess' circa 1500"),
      new Quote("Do not permit yourself to fall in love with the end-game play to the exclusion of entire games. It is well to have the whole story of how it happened; the complete play, not the denouement only. Do not embrace the rag-time and vaudeville of chess.",
                "Emanuel Lasker"),
      new Quote(
      ...
      new Quote(
          ...
          "Pal Benko"),
      new Quote("Even in the King's Gambit ... White is no longer trying to attack at all costs. He has had to adapt his approach and look for moves with a solid positional foundation",
                "Neil McDonald  (1998) "),
      new Quote("Even in the heat of a middlegame battle the master still has to bear in mind the outlines of a possible future ending.",
                "David Bronstein"),
      new Quote(
      ...
      new Quote("Every great master will find it useful to have his own theory on the openings, which only he himself knows, a theory which is closely linked with plans for the middle game.",
                "Mikhail Botvinnik"),
      ...
      new Quote("Excelling at chess has long been considered a symbol of more general intelligence. That is an incorrect assumption in my view, as pleasant as it might be.",
                "Garry Kasparov"),
      new Quote("Experience and the constant analysis of the most varied positions builds up a store of knowledge in a player's mind enabling him often at a glance to assess this or that position.",
                "Alexander Kotov"),
      new Quote(
          ...
          "Andy Soltis"),
      new Quote("Far from all of the obvious moves that go without saying are correct.",
                "David Bronstein"),
      new Quote(
      ...
      new Quote("First-class players lose to second-class players because second-class players sometimes play a first-class game.",
                "Siegbert Tarrasch"),
      new Quote("Fischer is Fischer, but a knight is a knight!",
                "Mikhail Tal"),
      new Quote("For a game it is too serious, for seriousness too much of a game.",
                "Moses Mendelssohn 1729-86"),
      new Quote("For every door the computers have closed they have opened a new one.",
                "Viswanathan Anand"),
      new Quote(
      ...
      new Quote("For my victory over Capablanca I am indebted primarily to my superiority in the field of psychology. Capablanca played, relying almost exclusively on his rich intuitive talent. But for the chess struggle nowadays one needs a subtle knowledge of human nature, an understanding of the opponent's psychology.",
                "Alexander Alekhine"),
      new Quote("For pleasure you can read the games collections of Andersson and Chigorin, but for benefit you should study Tarrasch, Keres and Bronstein.",
                "Mikhail Tal"),
      new Quote("Fortunately I’ve got a weak character, so I never did decide to dedicate myself to only one of my professions. And I’m very glad. After all, if I’d rejected chess or music then my life wouldn’t have been two times, but a hundred times less interesting.",
                "Mark Taimanov"),
      new Quote("From time to time, like many other players, I glance through my own games of earlier years, and return to positions and variations which have gone out of practice. I attempt to restore them, to find new ideas and plans.",
                "Yefim Geller"),
      ...
      new Quote("Having spent alarmingly large chunks of my life studying the white side of the Open Sicilian, I find myself asking, why did I bother?",
                "Daniel King"),
      new Quote("He played with enormous energy and great fighting spirit. Offering him a draw was a waste of time. He would decline it politely, but firmly. \"No, thank you,\" he would say and the fight would go on and on and on.",
      ...
      new Quote(
          ...
          "Yasser Seirawan"),
      new Quote("However hopeless the situation appears to be there yet always exists the possibility of putting up a stubborn resistance.",
                "Paul Keres"),
      new Quote(
      ...
      new Quote(
          ...
          "Mikhail Tal"),
      new Quote("I believe that the best style is a universal one, tactical and positional at the same time ...",
                "Susan Polgar"),
      new Quote("I cannot claim to thoroughly enjoy coaching, because it is very hard work if you are even moderately conscientious. Nevertheless it does provide a degree of satisfaction, not to mention a steady income, which is why I do it occasionally.",
                "Nigel Short"),
      new Quote(
