...
object Quote {
  ...
  val all = Vector(
      new Quote("When you see a good move, look for a better one.",
                "Emanuel Lasker"),
      new Quote(
      ...
      new Quote(
          ...
          "Bruce A. Moon"),
      new Quote("Strategy requires thought, tactics require observation.",
                "Max Euwe"),
      new Quote("I don’t believe in psychology. I believe in good moves.",
                "Bobby Fischer"),
      new Quote(
      ...
      new Quote(
          ...
          "Reuben Fine"),
      new Quote(
          "I give 98 percent of my mental energy to chess.", "Bobby Fischer"),
      new Quote(
      ...
      new Quote(
          ...
          "Mikhail Botvinnik"),
      new Quote("Only the player with the initiative has the right to attack.",
                "Wilhelm Steinitz"),
      new Quote(
      ...
      new Quote(
          ...
          "Emanuel Lasker"),
      new Quote("Life is like a game of chess, changing with each move.",
                "Chinese proverb"),
      new Quote("You cannot play at chess if you are kind-hearted.",
                "French proverb"),
      new Quote(
      ...
      new Quote(
          ...
          "Richard Reti"),
      new Quote("The pawns are the soul of the game.",
      ...
      new Quote("Chess is played with the mind and not with the hands!",
                "Renaud and Kahn"),
      ...
      new Quote(
          ...
          "Alfred Binet"),
      new Quote("Openings teach you openings. Endgames teach you chess!",
                "Stephan Gerzadowicz"),
      new Quote("My style is somewhere between that of Tal and Petrosian.",
                "Reshevsky"),
      new Quote(
      ...
      new Quote("Excellence at chess is one mark of a scheming mind.",
                "Sir Arthur Conan Doyle"),
      new Quote("A bad day of chess is better than any good day at work.",
                "Anonymous"),
      new Quote("Chess is the art of analysis.", "Mikhail Botvinnik"),
      new Quote("The mistakes are there, waiting to be made.",
                "Savielly Tartakower"),
      new Quote(
      ...
      new Quote(
          ...
          "Capablanca"),
      new Quote("The essence of chess is thinking about what chess is.",
                "David Bronstein"),
      new Quote("I am the best player in the world and I am here to prove it.",
                "Bobby Fischer"),
      new Quote(
      ...
      new Quote("Before the endgame, the Gods have placed the middle game.",
                "Siegbert Tarrasch"),
      ...
      new Quote("The defensive power of a pinned piece is only imaginary.",
                "Aaron Nimzovich"),
      new Quote(
      ...
      new Quote("One doesn’t have to play well, it’s enough to play better than your opponent.",
                "Siegbert Tarrasch"),
      ...
      new Quote("The most powerful weapon in chess is to have the next move.",
                "David Bronstein"),
      new Quote("He who fears an isolated queen’s pawn should give up chess.",
                "Siegbert Tarrasch"),
      new Quote("Different people feel differently about resigning.",
                "Bobby Fischer"),
      new Quote("Chess is not like life... it has rules!", "Mark Pasternak"),
      new Quote("It’s always better to sacrifice your opponent’s men.",
                "Savielly Tartakover"),
      new Quote(
      ...
      new Quote(
          ...
          "Siegbert Tarrasch"),
      new Quote("A sacrifice is best refuted by accepting it.",
                "Wilhelm Steinitz"),
      new Quote("Tactics flow from a superior position.", "Bobby Fischer"),
      new Quote("Later, I began to succeed in decisive games. Perhaps because I realized a very simple truth: not only was I worried, but also my opponent.",
                "Mikhail Tal"),
      ...
      new Quote(
          ...
          "Jose Raul Capablanca"),
      new Quote("There are two types of sacrifices: correct ones and mine.",
                "Mikhail Tal"),
      new Quote("Morphy was probably the greatest genius of them all.",
                "Bobby Fischer"),
      new Quote(
          "My opponents make good moves too. Sometimes I don’t take these things into consideration.",
          "Bobby Fischer"),
      new Quote("The combination player thinks forward; he starts from the given position, and tries the forceful moves in his mind.",
                "Emanuel Lasker"),
      new Quote("A chess game is divided into three stages: the first, when you hope you have the advantage, the second when you believe you have an advantage, and the third... when you know you’re going to lose!",
                "Savielly Tartakower"),
      new Quote("Chess demands total concentration.", "Bobby Fischer"),
      new Quote("Chess, like love, like music, has the power to make people happy.",
                "Siegbert Tarrasch"),
      new Quote("All my games are real.", "Bobby Fischer"),
      new Quote("Chess is everything: art, science and sport.",
                "Anatoly Karpov"),
      new Quote(
      ...
      new Quote(
          ...
          "Emanuel Lasker"),
      new Quote("Chess is war over the board. The object is to crush the opponents mind.",
                "Bobby Fischer"),
      new Quote("The passed pawn is a criminal, who should be kept under lock and key.  Mild measures, such as police surveillance, are not sufficient.",
                "Aaron Nimzovich"),
      new Quote("Chess holds its master in its own bonds, shackling the mind and brain so that the inner freedom of the very strongest must suffer.",
                "Albert Einstein"),
      new Quote("Human affairs are like a chess game: only those who do not take it seriously can be called good players.",
                "Hung Tzu Ch’eng"),
      new Quote(
      ...
      new Quote(
          ...
          "Italian proverb"),
      new Quote("You sit at the board and suddenly your heart leaps. Your hand trembles to pick up the piece and move it.  But what chess teaches you is that you must sit there calmly and think about whether its really a good idea and whether there are other better ideas.",
                "Stanley Kubrick"),
      new Quote(
          "Daring ideas are like chess men moved forward. They may be beaten, but they may start a winning game.",
          "Johann Wolfgang von Goethe"),
      new Quote("Of all my Russian books, the defense contains and diffuses the greatest ’warmth’ which may seem odd seeing how supremely abstract chess is supposed to be.",
                "Vladimir Nabokov"),
      new Quote("For surely of all the drugs in the world, chess must be the most permanently pleasurable.",
                "Assiac"),
      new Quote("A thorough understanding of the typical mating continuations makes the most complicated sacrificial combinations leading up to them not only not difficult, but almost a matter of course.",
                "Siegbert Tarrasch"),
      new Quote("Chess problems demand from the composer the same virtues that characterize all worthwhile art: originality, invention, conciseness, harmony, complexity, and splendid insincerity.",
                "Vladimir Nabokov"),
      new Quote(
          "Personally, I rather look forward to a computer program winning the world chess Championship. Humanity needs a lesson in humility.",
          "Richard Dawkings"),
      new Quote("The boy (then a 12 year old boy named Anatoly Karpov) doesn’t have a clue about chess, and there’s no future at all for him in this profession.",
                "Mikhail Botvinnik"),
      new Quote("As one by one I mowed them down, my superiority soon became apparent.",
                "Jose Capablanca"),
      new Quote(
          ...
          "Yasser Seirawan"),
      new Quote("Chess is ruthless; you’ve got to be prepared to kill people.",
                "Nigel Short"),
      new Quote("There must have been a time when men were demigods, or they could not have invented chess.",
                "Gustav Schenk"),
      ...
      new Quote("The game of chess is not merely an idle amusement; several very valuable qualities of the mind are to be acquired and strengthened by it, so as to become habits ready on all occasions; for life is a kind of chess.",
                "Benjamin Franklin"),
      ...
      new Quote("Avoid the crowd. Do your own thinking independently. Be the chess player, not the chess piece.",
                "Ralph Charell"),
      new Quote(
      ...
      new Quote(
          ...
          "Bruce Pandolfini"),
      new Quote("The battle for the ultimate truth will never be won.  And that’s why chess is so fascinating.",
                "Hans Kmoch"),
      new Quote("Chess makes man wiser and clear-sighted.", "Vladimir Putin"),
      new Quote("I am still a victim of chess. It has all the beauty of art and much more. It cannot be commercialized. chess is much purer than art in its social position.",
                "Marcel Duchamp"),
      new Quote("Blessed be the memory of him who gave the world this immortal game.",
                "A. G. Gardiner"),
      new Quote("In the perfect chess combination as in a first-rate short story, the whole plot and counter-plot should lead up to a striking finale, the interest not being allayed until the very last moment.",
                "Yates and Winter"),
      ...
      new Quote(
          ...
          "Vlastimil Hort"),
      new Quote("Chess is a more highly symbolic game, but the aggressions are therefore even more frankly represented in the play. It probably began as a war game; that is, the representation of a miniature battle between the forces of two kingdoms.",
                "Karl Meninger"),
      new Quote(
      ...
      new Quote(
          ...
          "Jeremy Silman"),
      new Quote("The chess pieces are the block alphabet which shapes thoughts; and these thoughts, although making a visual design on the chessboard, express their beauty abstractly, like a poem.",
                "Marcel Duchamp"),
      new Quote("Examine moves that smite! A good eye for smites is far more important than a knowledge of strategical principles.",
                "Purdy"),
      new Quote("Chess is like life.", "Boris Spassky"),
      new Quote("If your opponent offers you a draw, try to work out why he thinks he’s worse off.",
                "Nigel Short"),
      new Quote("Chess teaches you to control the initial excitement you feel when you see something that looks good and it trains you to think objectively when you’re in trouble.",
                "Stanley Kubrick"),
      ...
      new Quote(
          ...
          "Garry Kasparov"),
      new Quote("Man is a frivolous, a specious creature, and like a chess player, cares more for the process of attaining his goal than for the goal itself.",
                "Dostoyevsky"),
      new Quote(
      ...
      new Quote(
          ...
          "Siegbert Tarrasch"),
      new Quote("What is the object of playing a gambit opening?... To acquire a reputation of being a dashing player at the cost of losing a game.",
                "Siegbert Tarrasch"),
      new Quote("Pawns; they are the soul of this game, they alone form the attack and defense.",
                "Philidor"),
      new Quote(
      ...
      new Quote(
          ...
          "Mortimer Collins"),
      new Quote("The tactician must know what to do whenever something needs doing; the strategist must know what to do when nothing needs doing.",
                "Savielly Tartakover"),
      new Quote(
      ...
      new Quote(
          ...
          "Mark Twain"),
      new Quote("The tactician knows what to do when there is something to do; whereas the strategian knows what to do when there is nothing to do.",
                "Gerald Abrahams"),
      new Quote(
          "In chess, just as in life, today’s bliss may be tomorrow’s poison.",
          "Assaic"),
      new Quote("You may learn much more from a game you lose than from a game you win. You will have to lose hundreds of games before becoming a good player.",
                "Jose Raul Capablanca"),
      new Quote("The way he plays chess demonstrates a man’s whole nature.",
                "Stanley Ellin"),
      new Quote("You can only get good at chess if you love the game.",
                "Bobby Fischer"),
      new Quote("A man that will take back a move at chess will pick a pocket.", "Richard Fenton"),
      new Quote("Whoever sees no other aim in the game than that of giving checkmate to one’s opponent will never become a good chess player.",
                "Euwe"),
      new Quote(
      ...
      new Quote(
          ...
          "Richard Reti"),
      new Quote("Chess is a sea in which a gnat may drink and an elephant may bathe.",
                "Hindu proverb"),
      new Quote(
      ...
      new Quote(
          ...
          "Saudin Robovic"),
      new Quote("Chess is so inspiring that I do not believe a good player is capable of having an evil thought during the game.",
                "Wilhelm Steinitz"),
      new Quote(
      ...
      new Quote("By playing at chess then, we may learn: First: Foresight. Second: Circumspection. Third: Caution. And lastly, we learn by chess the habit of not being discouraged by present bad appearances in the state of our affairs, the habit of hoping for a favorable chance, and that of persevering in the secrets of resources.",
                "Benjamin Franklin"),
      new Quote("I prefer to lose a really good game than to win a bad one.",
                "David Levy"),
      new Quote("Capture of the adverse king is the ultimate but not the first object of the game.",
                "William Steinitz"),
      new Quote(
      ...
      new Quote("Chess is in its essence a game, in its form an art, and in its execution a science.",
                "Baron Tassilo"),
      new Quote("No price is too great for the scalp of the enemy king.",
                "Koblentz"),
      new Quote("In life, as in chess, ones own pawns block ones way.  A mans very wealth, ease, leisure, children, books, which should help him to win, more often checkmate him.",
                "Charles Buxton"),
      new Quote(
          "Chess is a part of culture and if a culture is declining then chess too will decline.",
          "Mikhail Botvinnik"),
      new Quote("A good sacrifice is one that is not necessarily sound but leaves your opponent dazed and confused.",
                "Rudolph Spielmann"),
      new Quote("Chess, like any creative activity, can exist only through the combined efforts of those who have creative talent, and those who have the ability to organize their creative work.",
                "Mikhail Botvinnik"),
      new Quote("One bad move nullifies forty good ones.", "Horowitz"),
      new Quote("Place the contents of the chess box in a hat, shake them up vigorously, pour them on the board from a height of two feet, and you get the style of Steinitz.",
                "H. E. Bird"),
      new Quote(
          "I have never in my life played the French Defence, which is the dullest of all openings.",
          "Wilhelm Steinitz"),
      new Quote("Pawns are born free, yet they are everywhere in chains.",
                "Rick Kennedy"),
      new Quote("It is not a move, even the best move that you must seek, but a realizable plan.",
      ...
      new Quote(
          ...
          "Irving Chernev"),
      new Quote("One of these modest little moves may be more embarrassing to your opponent than the biggest threat.",
                "Siegbert Tarrasch"),
      new Quote(
          "Live, lose, and learn, by observing your opponent how to win.",
          "Amber Steenbock"),
      new Quote("The older I grow, the more I value pawns.", "Keres"),
      new Quote("Everything is in a state of flux, and this includes the world of chess.",
                "Mikhail Botvinnik"),
      new Quote("The beauty of a move lies not in its appearance but in the thought behind it.",
                "Aaron Nimzovich"),
      ...
      new Quote(
          ...
          "Sytze Faber"),
      new Quote("The passion for playing chess is one of the most unaccountable in the world.",
                "H.G. Wells"),
      new Quote("Chess is so interesting in itself, as not to need the view of gain to induce engaging in it; and thence it is never played for money.",
                "Benjamin Franklin"),
      new Quote(
      ...
      new Quote(
          ...
          "Anand Viswanathan"),
      new Quote("Do you realize Fischer almost never has any bad pieces? He exchanges them, and the bad pieces remain with his opponents.",
                "Yuri Balashov"),
      new Quote(
      ...
      new Quote(
          ...
          "Andrew Soltis"),
      new Quote("I won’t play with you anymore. You have insulted my friend --when an opponent cursed himself for a blunder.",
                "Miguel Najdorf"),
      new Quote("You know, comrade Pachman, I don’t enjoy being a Minister, I would rather play chess like you.",
                "Che Guevara"),
      new Quote("It began to feel as though you were playing against chess itself --on playing against Robert Fischer.",
                "Walter Shipman"),
      new Quote("Checkers is for tramps.", "Paul Morphy"),
      new Quote("When you play Bobby, it is not a question if you win or lose.  It is a question if you survive.",
                "Boris Spassky"),
      new Quote("When you absolutely don’t know what to do anymore, it is time to panic.",
                "John van der Wiel"),
      new Quote("We like to think.", "Garry Kasparov"),
      new Quote(
          "Dazzling combinations are for the many, shifting wood is for the few.",
          "Georg Kieninger"),
      new Quote("In complicated positions, Bobby Fischer hardly had to be afraid of anybody.",
                "Paul Keres"),
      new Quote("It was clear to me that the vulnerable point of the American Grandmaster (Bobby Fischer) was in double-edged, hanging, irrational positions, where he often failed to find a win even in a won position.",
                "Efim Geller"),
      new Quote("I love all positions. Give me a difficult positional game, I will play it.  But totally won positions, I cannot stand them.",
                "Hein Donner"),
      new Quote("In Fischer’s hands, a slight theoretical advantage is as good a being a queen ahead.",
                "Isaac Kashdan"),
      ...
      new Quote("Bobby Fischer’s current state of mind is indeed a tragedy. One of the worlds greatest chess players - the pride and sorrow of American chess.",
                "Frank Brady"),
      new Quote(
      ...
      new Quote(
          ...
          "Jim Slater"),
      new Quote("I guess a certain amount of temperament is expected of chess geniuses.",
                "Ron Gross"),
      new Quote(
      ...
      new Quote(
          ...
          "Dave Regis"),
      new Quote("Fischer wanted to give the Russians a taste of their own medicine.",
                "Larry Evans"),
      new Quote("With or without the title, Bobby Fischer was unquestionably the greatest player of his time.",
                "Burt Hochberg"),
      new Quote("Fischer is completely natural. He plays no roles.  He’s like a child. Very, very simple.",
                "Zita Rajcsanyi"),
      new Quote("Spassky will not be psyched out by Fischer.", "Mike Goodall"),
      new Quote("Already at 15 years of age he was a Grandmaster, a record at that time, and his battle to reach the top was the background for all the major chess events of the 1960.",
                "Tim Harding"),
      new Quote("Fischer, who may or may not be mad as a hatter, has every right to be horrified.",
                "Jeremy Silman"),
      new Quote("When I asked Fischer why he had not played a certain move in our game, he replied: ‘Well, you laughed when I wrote it down!’",
                "Mikhail Tal"),
      new Quote("I look one move ahead... the best!", "Siegbert Tarrasch"),
      new Quote(
          "Fischer prefers to enter chess history alone.",
          "Miguel Najdorf"),
      new Quote("Bobby is the most misunderstood, misquoted celebrity walking the face of this earth.",
                "Yasser Seirawan"),
      new Quote(
      ...
      new Quote(
          ...
          "David Levy"),
      new Quote("Chess is a terrible game. If you have no center, your opponent has a freer position. If you do have a center, then you really have something to worry about!",
                "Siegbert Tarrasch"),
      new Quote("Many chess players were surprised when after the game, Fischer quietly explained: ’I had already analyzed this possibility’ in a position which I thought was not possible to foresee from the opening.",
                "Mikhail Tal"),
      new Quote("Suddenly it was obvious to me in my analysis I had missed what Fischer had found with the greatest of ease at the board.",
                "Mikhail Botvinnik"),
      ...
      new Quote(
          ...
          "Siegbert Tarrasch"),
      new Quote("Bobby is the finest chess player this country ever produced. His memory for the moves, his brilliance in dreaming up combinations, and his fierce determination to win are uncanny.",
                "John Collins"),
      new Quote(
      ...
      new Quote(
          ...
          "Boris Spassky"),
      new Quote("Bobby Fischer is the greatest chess player who has ever lived.",
                "Ken Smith"),
      new Quote("Up to this point white has been following well-known analysis. But now he makes a fatal error: he begins to use his own head.",
                "Siegbert Tarrasch"),
      new Quote(
          ...
          "Bruce Pandolfini"),
      new Quote("No other master has such a terrific will to win. At the board he radiates danger, and even the strongest opponents tend to freeze, like rabbits when they smell a panther. Even his weaknesses are dangerous.",
      ...
      new Quote(
          ...
          "John Collins"),
      new Quote("I consider Fischer to be one of the greatest opening experts ever.",
                "Keith Hayward"),
      new Quote("I like to say that Bobby Fischer was the greatest player ever. But what made Fischer a genius was his ability to blend an American freshness and pragmatism with Russian ideas about strategy.",
                "Bruce Pandolfini"),
      new Quote("At this time Fischer is simply a level above all the best chessplayers in the world.",
                "John Jacobs"),
      new Quote("I have always a slight feeling of pity for the man who has no knowledge of chess.",
                "Siegbert Tarrasch"),
      new Quote("There’s never before been a chess player with such a thorough knowledge of the intricacies of the game and such an absolutely indomitable will to win. I think Bobby is the greatest player that ever lived.",
                "Lisa Lane"),
      new Quote(
          "He who takes the queen’s Knight’s pawn will sleep in the streets.",
          "Anonymous"),
      new Quote("I had a toothache during the first game. In the second game I had a headache. In the third game it was an attack of rheumatism. In the fourth game, I wasn’t feeling well. And in the fifth game? Well, must one have to win every game?",
                "Siegbert Tarrasch"),
      new Quote(
          "The stomach is an essential part of the chess master.", "Bent Larsen"),
      new Quote("I’m not a materialistic person, in that, I don’t suffer the lack or loss of money.  The absence of worldly goods I don’t look back on. For chess is a way I can be as materialistic as I want without having to sell my soul ",
                "Jamie Walter Adams"),
      new Quote("These are not pieces, they are men! For any man to walk into the line of fire will be one less man in your army to fight for you. Value every troop and use him wisely, throw him not to the dogs as he is there to serve his king.",
                "Jamie Walter Adams"),
      new Quote(
          "Chess isn’t a game of speed, it is a game of speech through actions.",
          "Matthew Selman"),
      new Quote("Life like chess is about knowing to do the right move at the right time.",
                "Kaleb Rivera"),
      new Quote("Come on Harry!", "Simon Williams"),
      new Quote("Some people think that if their opponent plays a beautiful game, it’s okay to lose. I don’t. You have to be merciless.",
                "Magnus Carlsen"),
      new Quote("It's one of those types of positions where he has pieces on squares.",
                "John ~ZugAddict~ Chernoff"),
      new Quote("On the bright side, I no longer have any more pieces to lose.",
                "John ~ZugAddict~ Chernoff"),
      new Quote(
      ...
      new Quote(
          ...
          "John ~ZugAddict~ Chernoff"),
      new Quote("Most of the gods throw dice but Fate plays chess, and you don't find out until too late that he's been using two queens all along.",
                "Terry Pratchett"),
      new Quote(
      ...
      new Quote("When you trade, the key concern is not always the value of the pieces being exchanged, but what’s left on the board.",
                "Dan Heisman"),
      new Quote(
          "I detest the endgame. A well-played game should be practically decided in the middlegame.",
          "David Janowski"),
      new Quote("Many men, many styles; what is chess style but the intangible expression of the will to win.",
                "Aaron Nimzowitsch"),
      new Quote("Never play for the win, never play for the draw, just play chess!",
                "Khalifman"),
      new Quote("In chess, knowledge is a very transient thing. It changes so fast that even a single mouse-slip sometimes changes the evaluation.",
                "Viswanathan Anand"),
      new Quote(
          "Having good strategies in playing chess is often a good indication of being focused in life.",
          "Martin Dansky"),
      new Quote("Chess is an infinitely complex game, which one can play in infinitely numerous and varied ways.",
                "Vladimir Kramnik"),
      new Quote("Chess: It’s like alcohol. It’s a drug. I have to control it, or it could overwhelm me.",
                "Charles Krauthammer"),
      new Quote(
          "Drawing general conclusions about your main weaknesses can provide a great stimulus to further growth.",
          "Alexander Kotov"),
      new Quote("The good thing in chess is that very often the best moves are the most beautiful ones. The beauty of logic.",
                "Boris Gelfand"),
      new Quote("Any experienced player knows how a change in the character of the play influences your psychological mood.",
                "Garry Kasparov"),
      ...
      new Quote("Pawns are such fascinating pieces, too...So small, almost insignificant, and yet--they can depose kings.",
                "Lavie Tidhar"),
      new Quote(
      ...
      new Quote("If you don't know what to do, find your worst piece and look for a better square.",
                "Gerard Schwarz"),
      new Quote("Players who balk at playing one-minute chess are failing to see the whole picture. They shouldn’t be worrying that they will make more mistakes – they should be rubbing their hands in glee at the thought of all the mistakes their opponents will make.",
                "Hikaru Nakamura"),
      new Quote("A Chess game is divided into three stages: the first, when you hope you have the advantage, the second when you believe that you have an advantage, and the third ... when you know you're going to lose !",
                "Savielly Tartakower"),
      new Quote("A Queen's sacrifice, even when fairly obvious, always rejoices the heart of the chess-lover.",
                "Savielly Tartakower"),
      new Quote(
          ...
          "Emanuel Lasker"),
      new Quote("A chess player never has a heart attack in a good position.",
                "Bent Larsen"),
      new Quote(
          "A computer beat me in chess, but it was no match when it came to kickboxing.",
          "Emo Phillips"),
      new Quote("A considerable role in the forming of my style was played by an early attraction to study composition.",
                "Vasily Smyslov"),
      new Quote(
          "A defeatist spirit must inevitably lead to disaster.",
          "Eugene Znosko-Borovski"),
      new Quote("A draw can be obtained not only by repeating moves, but also by one weak move.",
                "Savielly Tartakower"),
      new Quote("A draw may be the beautiful and logical result of fine attacks and parries; and the public ought to appreciate such games, in contrast, of course, to the fear-and-laziness draws.",
                "Bent Larsen"),
      new Quote(
          "A gambit never becomes sheer routine as long as you fear you may lose the king and pawn ending!",
          "Bent Larsen"),
      new Quote("A great chess player always has a very good memory.",
                "Leonid Shamkovich"),
      new Quote(
      ...
      new Quote(
          ...
          "Boris Gelfand"),
      new Quote("A male scorpion is stabbed to death after mating. In chess, the powerful queen often does the same to the king without giving him the satisfaction of a lover.",
                "Gregor Piatigorsky"),
      new Quote(
          "A pawn, when separated from his fellows, will seldom or never make a fortune.",
          "Francois-Andre Danican Philidor"),
      new Quote("A plan is made for a few moves only, not for the whole game.",
                "Rueben Fine"),
      new Quote("A player can sometimes afford the luxury of an inaccurate move, or even a definite error, in the opening or middlegame without necessarily obtaining a lost position. In the endgame ... an error can be decisive, and we are rarely presented with a second chance.",
                "Paul Keres"),
      new Quote(
          ...
          "Leonid Shamkovich"),
      new Quote("A sport, a struggle for results and a fight for prizes. I think that the discussion about “chess is science or chess is art” is already inappropriate. The purpose of modern chess is to reach a result.",
                "Alexander Morozevich"),
      new Quote("A strong player requires only a few minutes of thought to get to the heart of the conflict. You see a solution immediately, and half an hour later merely convince yourself that your intuition has not deceived you.",
                "David Bronstein"),
      new Quote("A win gives one a feeling of self-affirmation, and success - a feeling of self-expression, but only a sensible harmonization between these urges can bring really great achievements in chess.",
                "Oleg Romanishin"),
      new Quote("Above all else, before playing in competitions a player must have regard to his health, for if he is suffering from ill-health he cannot hope for success. In this connection the best of all tonics is 15 to 20 days in the fresh air, in the country.",
                "Mikhail Botvinnik"),
      new Quote("According to such great attacking players as Bronstein and Tal, most combinations are inspired by the player's memories of earlier games.",
                "Pal Benko"),
      new Quote(
          ...
          "Boris Spassky"),
      new Quote("After a great deal of discussion in Soviet literature about the correct definition of a combination, it was decided that from the point of view of a methodical approach it was best to settle on this definition - A combination is a forced variation with a sacrifice.",
                "Alexander Kotov"),
      new Quote(
      ...
      new Quote(
          ...
          "Eugene Znosko-Borowski"),
      new Quote("All lines of play which lead to the imprisonment of the bishop are on principle to be condemned. (on the closed Ruy Lopez)",
                "Siegbert Tarrasch"),
      new Quote("All that matters on the chessboard is good moves.", "Bobby Fischer"),
      new Quote("All that now seems to stand between Nigel and the prospect of the world crown is the unfortunate fact that fate brought him into this world only two years after Kasparov.",
      ...
      new Quote(
          ...
          "Bobby Fischer"),
      new Quote("Among top grandmasters the Dutch is a rare defense, which is good reason to play it! It has not been studied very deeply by many opponents, and theory, based on a small number of 'reliable' games, must be rather unreliable.",
                "Bent Larsen"),
      new Quote(
          ...
          "Anatoly Karpov"),
      new Quote("An innovation need not be especially ingenious, but it must be well worked out.",
                "Paul Keres"),
      new Quote("An isolated pawn spreads gloom all over the chessboard.", "Savielly Tartakower"),
      new Quote("Analysis is a glittering opportunity for training: it is just here that capacity for work, perseverence and stamina are cultivated, and these qualities are, in truth, as necessary to a chess player as a marathon runner.",
                "Lev Polugaevsky"),
      new Quote("Analysis, if it is really carried out with a complete concentration of his powers, forms and completes a chess player.",
                "Lev Polugaevsky"),
      new Quote("Anyone who wishes to learn how to play chess well must make himself or herself thoroughly conversant with the play in positions where the players have castled on opposite sides.",
                "Alexander Kotov"),
      new Quote("Apart from direct mistakes, there is nothing more ruinous than routine play, the aim of which is mechanical development.",
                "Alexei Suetin"),
      new Quote("As Rousseau could not compose without his cat beside him, so I cannot play chess without my king's bishop. In its absense the game to me is lifeless and void. The vitalizing factor is missing, and I can devise no plan of attack.",
                "Siegbert Tarrasch"),
      new Quote(
      ...
      new Quote(
          ...
          "Alexander Alekhine"),
      new Quote("As a rule, the more mistakes there are in a game, the more memorable it remains, because you have suffered and worried over each mistake at the board.",
                "Victor Kortchnoi"),
      new Quote("As long as my opponent has not yet castled, on each move I seek a pretext for an offensive. Even when I realize that the king is not in danger.",
                "Mikhail Tal"),
      new Quote(
      ...
      new Quote("Attackers may sometimes regret bad moves, but it is much worse to forever regret an opportunity you allowed to pass you by.",
                "Garry Kasparov"),
      new Quote(
      ...
      new Quote("Before Geller we did not understand the King's Indian Defence.",
                "Mikhail Botvinnik"),
      new Quote("Begone! Ignorant and impudent knight, not even in chess can a King be taken.",
                "King Louis VI (reputedly stated to one of his knights in 1110 after he was nearly captured by enemy forces)"),
      new Quote("Black's d5-square is too weak.",
      ...
      new Quote("Bobby Fischer started off each game with a great advantage: after the opening he had used less time than his opponent and thus had more time available later on. The major reason why he never had serious time pressure was that his rapid opening play simply left sufficient time for the middlegame.",
                "Edmar Mednis"),
      new Quote("Books on the openings abound; nor are works on the end game wanting; but those on the middle game can be counted on the fingers of one hand.",
                "Harry Golombek"),
      new Quote(
          ...
          "Garry Kasparov"),
      new Quote("Botvinnik tried to take the mystery out of Chess, always relating it to situations in ordinary life. He used to call chess a typical inexact problem similar to those which people are always having to solve in everyday life.",
                "Garry Kasparov"),
      new Quote("But alas! Like many another consummation devoutly to be wished, the actual performance was a disappointing one. (on the long awaited Lasker-Capablanca match in 1921)",
                "Fred Reinfeld"),
      new Quote(
          ...
          "Anatoly Karpov"),
      new Quote("But whatever you might say and whatever I might say, a machine which can play chess with people is one of the most marvellous wonders of our 20th century!",
                "David Bronstein"),
      new Quote("But you see when I play a game of Bobby, there is no style. Bobby played perfectly. And perfection has no style.",
                "Miguel Najdorf"),
      new Quote("By all means examine the games of the great chess players, but don't swallow them whole. Their games are valuable not for their separate moves, but for their vision of chess, their way of thinking.",
                "Anatoly Karpov"),
      new Quote("By positional play a master tries to prove and exploit true values, whereas by combinations he seeks to refute false values ... A combination produces an unexpected re-assessment of values.",
                "Emanuel Lasker"),
      new Quote("By some ardent enthusiasts Chess has been elevated into a science or an art. It is neither; but its principal characteristic seems to be what human nature mostly delights in a fight.",
                "Emanuel Lasker"),
      new Quote("By strictly observing Botvinnik's rule regarding the thorough analysis of one's own games, with the years I have come to realize that this provides the foundation for the continuous development of chess mastery.",
                "Garry Kasparov"),
      new Quote(
      ...
      new Quote(
          ...
          "Emanuel Lasker"),
      new Quote("Can you imagine the relief it gives a mother when her child amuses herself quietly for hours on end?",
                "Klara Polgar"),
      new Quote("Capablanca did not apply himself to opening theory (in which he never therefore achieved much), but delved deeply into the study of end-games and other simple positions which respond to technique rather than to imagination.",
                "Max Euwe"),
      new Quote("Chess can help a child develop logical thinking, decision making, reasoning, and pattern recognition skills, which in turn can help math and verbal skills.",
                "Susan Polgar"),
      new Quote("Chess can learn a lot from poker. First, chess media and sponsors should emphasize its glamorous aspects: worldwide traveling, parties and escape from real world responsibilities.",
                "Jennifer Shahade"),
      new Quote("Chess can never reach its height by following in the path of science ... Let us, therefore, make a new effort and with the help of our imagination turn the struggle of technique into a battle of ideas.",
                "Jose Capablanca"),
      new Quote(
      ...
      new Quote(
          ...
          "Rueben Fine"),
      new Quote("Chess is a contributor to net human unhappiness, since the pleasure of victory is greatly exceeded by the pain of defeat.",
                "Bill Hartston"),
      ...
      new Quote("Chess is a miniature version of life. To be successful, you need to be disciplined, assess resources, consider responsible choices and adjust when circumstances change.",
                "Susan Polgar"),
      ...
      new Quote("Chess is a unique cognitive nexus, a place where art and science come together in the human mind and are refined and improved by experience.",
                "Garry Kasparov"),
      new Quote(
      ...
      new Quote("Chess is my profession. I am my own boss; I am free. I like literature and music, classical especially. I am in fact quite normal; I have a Bohemian profession without being myself a Bohemian. I am neither a conformist nor a great revolutionary.",
                "Bent Larsen"),
      new Quote("Chess is not for the faint-hearted; it absorbs a person entirely. To get to the bottom of this game, he has to give himself up into slavery. Chess is difficult, it demands work, serious reflection and zealous research.",
                "Wilhelm Steinitz"),
      ...
      new Quote("Chess is thirty to forty percent psychology. You don't have this when you play a computer. I can't confuse it.",
                "Judit Polgar"),
      new Quote("Chess is thriving. There are ever less round robin tournaments and ever more World Champions.",
                "Robert Huebner (1990, Schach)"),
      new Quote("Chess is, above all, a fight.", "Emanuel Lasker"),
      new Quote("Chess is, in essence, a game for children. Computers have exacerbated the trends towards youth because they now have an immensely powerful tool at their disposal and can absorb vast amounts of information extremely quickly.",
                "Nigel Short"),
      new Quote("Chess masters as well as chess computers deserve less reverence than the public accords them.",
                "Eliot Hearst"),
      new Quote("Chess programs are our enemies, they destroy the romance of chess. They take away the beauty of the game. Everything can be calculated.",
                "Levon Aronian"),
      new Quote(
      ...
      new Quote("Combinations with a queen sacrifice are among the most striking and memorable ...",
                "Anatoly Karpov"),
      new Quote("Concentrate on material gains. Whatever your opponent gives you take, unless you see a good reason not to.",
                "Bobby Fischer"),
      new Quote("Condemned by theory, the Allgaier, certainly one of the most romantic of gambits, is generally successful in practice (and yet so rarely played). Why does the defender often seem hypnotized, quite demoralized?",
                "Tony Santasiere"),
      new Quote("Confidence is very important – even pretending to be confident. If you make a mistake but do not let your opponent see what you are thinking then he may overlook the mistake.",
                "Viswanathan Anand"),
      new Quote(
          "Contrary to many young colleagues I do believe that it makes sense to study the classics.",
          "Magnus Carlsen"),
      new Quote("Deschapelles became a first-rate player in three days, at the age of something like thirty. Nobody ever believed the statement, not even Deschapelles himself, although his biographer declares he had told the lie so often that he at last forgot the facts of the case.",
                "Frederick Milne Edge"),
      new Quote(
          "Despite the development of chess theory, there is much that remains secret and unexplored in chess.",
          "Vasily Smyslov"),
      new Quote("Do not bring your Queen out too early.",
      ...
      new Quote(
          ...
          "Emanuel Lasker"),
      new Quote("Do not pick a move from a list of computer lines - use your own brains. This is important, especially for young players. It's better to study a worse line well than to reproduce a better computer line.",
                "Laszlo Hazai"),
      new Quote(
          "Don't be afraid of losing, be afraid of playing a game and not learning something.",
          "Dan Heisman"),
      new Quote("Don't even mention losing to me. I can't stand to think of it.",
                "Bobby Fischer"),
      new Quote(
          "Don't worry about your rating, work on your playing strength and your rating will follow.",
          "Dan Heisman"),
      new Quote("Don't worry kids, you'll find work. After all, my machine will need strong chess player-programmers. You will be the first.",
                "Mikhail Botvinnik (to Karpov & students, 1965)"),
      new Quote("Drawn games are sometimes more scintillating than any conclusive contest.",
                "Savielly Tartakower"),
      new Quote("During a chess tournament a master must envisage himself as a cross between an ascetic monk and a beast of prey.",
                "Alexander Alekhine"),
      ...
      new Quote("Endings of one rook and pawns are about the most common sort of endings arising on the chess board. Yet though they do occur so often, few have mastered them thoroughly. They are often of a very difficult nature, and sometimes while apparently very simple they are in reality extremely intricate.",
                "Jose Capablanca"),
      new Quote("Enormous self-belief, intuition, the ability to take a risk at a critical moment and go in for a very dangerous play with counter-chances for the opponent - it is precisely these qualities that distinguish great players.",
                "Garry Kasparov"),
      new Quote("Errors have nothing to do with luck; they are caused by time pressure, discomfort or unfamiliarilty with a position, distractions, feelings of intimidation, nervous tension, overambition, excessive caution, and dozens of other psychological factors.",
                "Pal Benko"),
      new Quote(
      ...
      new Quote(
          ...
          "Tigran Petrosian"),
      new Quote("Even when the time control has been reached, there is one situation where you want to act as if it has not: when your position is absolutely lost.",
                "Edmar Mednis"),
      ...
      new Quote(
          ...
          "Mikhail Botvinnik"),
      new Quote("Every month I look through some ten thousand games, so not as to miss any new ideas and trends.",
                "Vladimir Kramnik"),
      new Quote("Every move creates a weakness.", "Siegbert Tarrasch"),
      new Quote("Excellent ! I will still be in time for the ballet !",
      ...
      new Quote("Excelling at chess has long been considered a symbol of more general intelligence. That is an incorrect assumption in my view, as pleasant as it might be.",
                "Garry Kasparov"),
      new Quote(
          ...
          "Alexander Kotov"),
      new Quote("Failing to open the center at the right moment - a common error by White in the Exchange Lopez - can allow Black an excellent game.",
                "Andy Soltis"),
      new Quote(
          "Far from all of the obvious moves that go without saying are correct.",
          "David Bronstein"),
      new Quote("Few things are as psychologically brutal as chess.",
                "Garry Kasparov"),
      new Quote(
      ...
      new Quote(
          "First restrain, next blockade, lastly destroy.", "Aron Nimzowitsch"),
      new Quote("First-class players lose to second-class players because second-class players sometimes play a first-class game.",
                "Siegbert Tarrasch"),
      new Quote(
      ...
      new Quote(
          ...
          "Viswanathan Anand"),
      new Quote("For me right now I think being the world number one is a bigger deal than being the world champion because I think it shows better who plays the best chess. That sounds self-serving but I think it’s also right. (2012)",
                "Magnus Carlsen"),
      new Quote("For me, chess is a language, and if it's not my native tongue, it is one I learned via the immersion method at a young age.",
                "Garry Kasparov"),
      new Quote("For me, chess is at the same time a game, a sport, a science and an art. And perhaps even more than that,. There is someting hard to explain to those who do not know the game well. One must first learn to play it correctly in order to savor its richness.",
                "Bent Larsen"),
      new Quote("For me, chess is not a profession, it is a way of life, a passion. People may feel that I have conquered the peak and will not have to struggle. Financially, perhaps that is true; but as far as chess goes, I’m still learning a lot!",
                "Viswanathan Anand"),
      ...
      new Quote(
          ...
          "Yefim Geller"),
      new Quote("Furman astounded me with his chess depth, a depth which he revealed easily and naturally, as if all he were doing was establishing well-known truths.",
                "Anatoly Karpov"),
      new Quote(
          ...
          "Hikaru Nakamura"),
      new Quote("Genius. It's a word. What does it really mean? If I win I'm a genius. If I don't, I'm not.",
                "Bobby Fischer"),
      new Quote(
          ...
          "Alexander Kotov"),
      new Quote("Had I not played the Sicilian with Black I could have saved myself the trouble of studying for more than 20 years all the more popular lines of this opening, which comprise probably more than 25 percent of all published opening theory!",
                "Bent Larsen"),
      new Quote("Has he some psychological antipathy to realism? I am no psychologist, and cannot say. The fact remains that Euwe commits the most inexplicable mistakes in thoroughly favorable positions, and that this weakness has consistently tarnished his record.",
                "Hans Kmoch"),
      new Quote("Haste is never more dangerous than when you feel that victory is in your grasp.",
                "Eugene Znosko-Borovsky"),
      ...
      new Quote(
          ...
          "Emanuel Lasker"),
      new Quote("Here is a definition which correctly reflects the course of thought and action of a grandmaster: The plan in a game of chess is the sum total of successive strategical operations which are each carried out according to separate ideas arising from the demands of the position.",
                "Alexander Kotov"),
      new Quote(
      ...
      new Quote(
          ...
          "Mikhail Botvinnik"),
      new Quote("I always urge players to study composed problems and endgames.",
                "Pal Benko"),
      new Quote("I am acutely conscious, from vast experience in opens, that guys around, say 2100 or more can definitely play chess and that one often has to work very hard to beat them.",
                "Nigel Short"),
      new Quote("I am both sad and pleased that in his last tournament, Rashid Gibiatovich came to my home in Latvia. He did not take first place, but the prize for beauty, as always, he took with him. Players die, tournaments are forgotten, but the works of great artists are left behind them to live on forever. (on Nezhmetdinov)",
                "Mikhail Tal"),
      new Quote("I am pleased that in a match for the World Championship I was able to conduct a game in the style of Akiba Rubinstein, where the entire strategic course was maintained from the first to the last move. (on Game 7 of his 2012 match with Anand)",
                "Boris Gelfand"),
      new Quote("I am trying to beat the guy sitting across from me and trying to choose the moves that are most unpleasant for him and his style.",
                "Magnus Carlsen"),
      new Quote("I believe in magic ... There is magic in the creative faculty such as great poets and philosophers conspicuously possess, and equally in the creative chessmaster.",
                "Emanuel Lasker"),
      new Quote(
