...
private[tournament] case class Member(channel: JsChannel,
...
private[tournament] case class Talk(tourId: String,
                                    u: String,
                                    t: String,
                                    troll: Boolean)
private[tournament] case object Reload
private[tournament] case class StartGame(game: Game)
private[tournament] case class Connected(enumerator: JsEnumerator,
                                         member: Member)
