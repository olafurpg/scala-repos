...
private[api] final class GameApi(netBaseUrl: String,
                                 apiToken: String,
                                 pgnDump: PgnDump,
  ...
  private def gamesJson(withAnalysis: Boolean,
                        withMoves: Boolean,
                        withOpening: Boolean,
                        withFens: Boolean,
                        withMoveTimes: Boolean,
            ...
            case (p, i) =>
              p.color.name -> Json
                .obj(
                    ...
                    "moveTimes" -> withMoveTimes.fold(g.moveTimes.zipWithIndex
                                                        .filter(_._2 % 2 == i)
                                                        .map(_._1),
                                                      JsNull),
