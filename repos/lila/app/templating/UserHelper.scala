...
trait UserHelper { self: I18nHelper with StringHelper with NumberHelper =>
  ...
  def userIdLink(userIdOption: Option[String],
  ...
  def lightUserLink(user: LightUser,
                    cssClass: Option[String] = None,
                    withOnline: Boolean = true,
                    withTitle: Boolean = true,
                    truncate: Option[Int] = None,
  ...
  def usernameLink(usernameOption: Option[String],
                   cssClass: Option[String] = None,
                   withOnline: Boolean = true,
                   withTitle: Boolean = true,
  ...
  protected def userClass(userId: String,
  ...
  def userGameFilterTitleNoTag(info: UserInfo,
                               filter: GameFilter)(implicit ctx: UserContext) =
    Html((filter match {
