...
object TypeClass {
  ...
  lazy val foldable1 =
    TypeClass("Foldable1", *->*, extendsList = Seq(foldable))
  lazy val traverse =
...
object GenTypeClass {
  ...
  case class TypeClassSource(mainFile: SourceFile,
