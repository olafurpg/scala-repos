...
object ScalazProperties
  ...
  object semigroup
    def associative[A](
        implicit A: Semigroup[A], eqa: Equal[A], arb: Arbitrary[A]) =
      forAll(A.semigroupLaw.associative _)

    def laws[A](implicit A: Semigroup[A],
                eqa: Equal[A],
  ...
  object monoid
    def leftIdentity[A](
        implicit A: Monoid[A], eqa: Equal[A], arb: Arbitrary[A]) =
    ...
    def laws[A](
        implicit A: Monoid[A], eqa: Equal[A], arb: Arbitrary[A]): Properties =
  ...
  object invariantFunctor
    def identity[F[_], X](implicit F: InvariantFunctor[F],
                          afx: Arbitrary[F[X]],
                          ef: Equal[F[X]]) =
      forAll(F.invariantFunctorLaw.invariantIdentity[X] _)

    def composite[F[_], X, Y, Z](implicit F: InvariantFunctor[F],
                                 af: Arbitrary[F[X]],
                                 axy: Arbitrary[(X => Y)],
                                 ayz: Arbitrary[(Y => Z)],
                                 ayx: Arbitrary[(Y => X)],
    ...
    def laws[F[_]](implicit F: InvariantFunctor[F],
                   af: Arbitrary[F[Int]],
  ...
  object functor
    def identity[F[_], X](
        implicit F: Functor[F], afx: Arbitrary[F[X]], ef: Equal[F[X]]) =
      forAll(F.functorLaw.identity[X] _)

    def composite[F[_], X, Y, Z](implicit F: Functor[F],
                                 af: Arbitrary[F[X]],
                                 axy: Arbitrary[(X => Y)],
                                 ayz: Arbitrary[(Y => Z)],
                                 ef: Equal[F[Z]]) =
    ...
    def laws[F[_]](implicit F: Functor[F],
                   af: Arbitrary[F[Int]],
                   axy: Arbitrary[(Int => Int)],
                   ef: Equal[F[Int]]): Properties =
  ...
  object align
    def collapse[F[_], A](
        implicit F: Align[F], E: Equal[F[A \&/ A]], A: Arbitrary[F[A]]): Prop =
      forAll(F.alignLaw.collapse[A] _)
    def laws[F[_]](implicit F: Align[F],
                   af: Arbitrary[F[Int]],
                   e: Equal[F[Int]],
  ...
  object apply  self =>
    def composition[F[_], X, Y, Z](implicit ap: Apply[F],
                                   afx: Arbitrary[F[X]],
                                   au: Arbitrary[F[Y => Z]],
                                   av: Arbitrary[F[X => Y]],
                                   e: Equal[F[Z]]) =
    ...
    def laws[F[_]](implicit F: Apply[F],
                   af: Arbitrary[F[Int]],
  ...
  object applicative
    def identity[F[_], X](
        implicit f: Applicative[F], afx: Arbitrary[F[X]], ef: Equal[F[X]]) =
      forAll(f.applicativeLaw.identityAp[X] _)

    def homomorphism[F[_], X, Y](implicit ap: Applicative[F],
                                 ax: Arbitrary[X],
                                 af: Arbitrary[X => Y],
                                 e: Equal[F[Y]]) =
      forAll(ap.applicativeLaw.homomorphism[X, Y] _)

    def interchange[F[_], X, Y](implicit ap: Applicative[F],
                                ax: Arbitrary[X],
                                afx: Arbitrary[F[X => Y]],
                                e: Equal[F[Y]]) =
      forAll(ap.applicativeLaw.interchange[X, Y] _)

    def mapApConsistency[F[_], X, Y](implicit ap: Applicative[F],
                                     ax: Arbitrary[F[X]],
                                     afx: Arbitrary[X => Y],
                                     e: Equal[F[Y]]) =
      forAll(ap.applicativeLaw.mapLikeDerived[X, Y] _)

    def laws[F[_]](implicit F: Applicative[F],
                   af: Arbitrary[F[Int]],
                   aff: Arbitrary[F[Int => Int]],
                   e: Equal[F[Int]]): Properties =
  ...
  object bind
    def associativity[M[_], X, Y, Z](implicit M: Bind[M],
                                     amx: Arbitrary[M[X]],
                                     af: Arbitrary[(X => M[Y])],
                                     ag: Arbitrary[(Y => M[Z])],
                                     emz: Equal[M[Z]]) =
    ...
    def bindApConsistency[M[_], X, Y](implicit M: Bind[M],
                                      amx: Arbitrary[M[X]],
                                      af: Arbitrary[M[X => Y]],
                                      emy: Equal[M[Y]]) =
      forAll(M.bindLaw.apLikeDerived[X, Y] _)

    def laws[M[_]](implicit a: Bind[M],
                   am: Arbitrary[M[Int]],
  ...
  object bindRec
    def tailrecBindConsistency[M[_], X](implicit M: BindRec[M],
                                        ax: Arbitrary[X],
                                        af: Arbitrary[X => M[X]],
                                        emx: Equal[M[X]]) =
      forAll(M.bindRecLaw.tailrecBindConsistency[X] _)

    def laws[M[_]](implicit a: BindRec[M],
                   am: Arbitrary[M[Int]],
                   af: Arbitrary[Int => M[Int]],
                   ag: Arbitrary[M[Int => Int]],
                   e: Equal[M[Int]]): Properties =
  ...
  object monad
    def rightIdentity[M[_], X](
        implicit M: Monad[M], e: Equal[M[X]], a: Arbitrary[M[X]]) =
    ...
    def laws[M[_]](implicit a: Monad[M],
                   am: Arbitrary[M[Int]],
                   af: Arbitrary[Int => M[Int]],
                   ag: Arbitrary[M[Int => Int]],
                   e: Equal[M[Int]]): Properties =
  ...
  object cobind
    def cobindAssociative[F[_], A, B, C, D](implicit F: Cobind[F],
                                            D: Equal[D],
                                            fa: Arbitrary[F[A]],
                                            f: Arbitrary[F[A] => B],
                                            g: Arbitrary[F[B] => C],
    ...
    def laws[F[_]](implicit a: Cobind[F],
                   am: Arbitrary[F[Int]],
                   e: Equal[F[Int]]): Properties =
  ...
  object comonad
    def cobindLeftIdentity[F[_], A](
        implicit F: Comonad[F], F0: Equal[F[A]], fa: Arbitrary[F[A]]) =
      forAll(F.comonadLaw.cobindLeftIdentity[A] _)

    def cobindRightIdentity[F[_], A, B](implicit F: Comonad[F],
                                        F0: Equal[B],
                                        fa: Arbitrary[F[A]],
                                        f: Arbitrary[F[A] => B]) =
      forAll(F.comonadLaw.cobindRightIdentity[A, B] _)

    def laws[F[_]](implicit a: Comonad[F],
                   am: Arbitrary[F[Int]],
  ...
  object traverse
    def identityTraverse[F[_], X, Y](implicit f: Traverse[F],
                                     afx: Arbitrary[F[X]],
                                     axy: Arbitrary[X => Y],
                                     ef: Equal[F[Y]]) =
      forAll(f.traverseLaw.identityTraverse[X, Y] _)

    def purity[F[_], G[_], X](implicit f: Traverse[F],
                              afx: Arbitrary[F[X]],
                              G: Applicative[G],
                              ef: Equal[G[F[X]]]) =
  ...
  object bifoldable
    def leftFMConsistent[F[_, _], A, B](implicit F: Bifoldable[F],
                                        afa: Arbitrary[F[A, B]],
                                        ea: Equal[A],
                                        eb: Equal[B]) =
      forAll(F.bifoldableLaw.leftFMConsistent[A, B] _)

    def rightFMConsistent[F[_, _], A, B](implicit F: Bifoldable[F],
                                         afa: Arbitrary[F[A, B]],
                                         ea: Equal[A],
                                         eb: Equal[B]) =
    ...
    def laws[F[_, _]](
        implicit fa: Arbitrary[F[Int, Int]], F: Bifoldable[F]): Properties =
  ...
  object bitraverse
    def laws[F[_, _]](implicit fa: Arbitrary[F[Int, Int]],
                      F: Bitraverse[F],
                      EF: Equal[F[Int, Int]]): Properties =
  ...
  object plus
    def associative[F[_], X](
        implicit f: Plus[F], afx: Arbitrary[F[X]], ef: Equal[F[X]]) =
      forAll(f.plusLaw.associative[X] _)

    def laws[F[_]](implicit F: Plus[F],
                   afx: Arbitrary[F[Int]],
                   ef: Equal[F[Int]]): Properties =
  ...
  object plusEmpty
    def leftPlusIdentity[F[_], X](
        implicit f: PlusEmpty[F], afx: Arbitrary[F[X]], ef: Equal[F[X]]) =
    ...
    def laws[F[_]](implicit F: PlusEmpty[F],
                   afx: Arbitrary[F[Int]],
  ...
  object isEmpty
    ...
    def emptyPlusIdentity[F[_], X](
        implicit f: IsEmpty[F], afx: Arbitrary[F[X]]) =
      forAll(f.isEmptyLaw.emptyPlusIdentity[X] _)

    def laws[F[_]](implicit F: IsEmpty[F],
                   afx: Arbitrary[F[Int]],
                   ef: Equal[F[Int]]): Properties =
  ...
  object monadPlus
    def emptyMap[F[_], X](
        implicit f: MonadPlus[F], afx: Arbitrary[X => X], ef: Equal[F[X]]) =
      forAll(f.monadPlusLaw.emptyMap[X] _)

    def leftZero[F[_], X](
        implicit F: MonadPlus[F], afx: Arbitrary[X => F[X]], ef: Equal[F[X]]) =
      forAll(F.monadPlusLaw.leftZero[X] _)

    def rightZero[F[_], X](
        implicit F: MonadPlus[F], afx: Arbitrary[F[X]], ef: Equal[F[X]]) =
      forAll(F.strongMonadPlusLaw.rightZero[X] _)

    def laws[F[_]](implicit F: MonadPlus[F],
                   afx: Arbitrary[F[Int]],
    ...
    def strongLaws[F[_]](implicit F: MonadPlus[F],
                         afx: Arbitrary[F[Int]],
                         afy: Arbitrary[F[Int => Int]],
                         ef: Equal[F[Int]]) =
      newProperties("monad plus")  p =>
  ...
  object foldable
    def leftFMConsistent[F[_], A](
        implicit F: Foldable[F], afa: Arbitrary[F[A]], ea: Equal[A]) =
  ...
  object foldable1
    ...
    def leftFM1Consistent[F[_], A](
        implicit F: Foldable1[F], fa: Arbitrary[F[A]], ea: Equal[A]) =
  ...
  object traverse1
    def identityTraverse1[F[_], X, Y](implicit f: Traverse1[F],
                                      afx: Arbitrary[F[X]],
                                      axy: Arbitrary[X => Y],
                                      ef: Equal[F[Y]]) =
  ...
  object zip
    def zipPreservation[F[_], X](implicit F: Zip[F],
                                 FF: Functor[F],
                                 afx: Arbitrary[F[X]],
                                 ef: Equal[F[X]]) =
      forAll(F.zipLaw.zipPreservation[X] _)

    def zipSymmetric[F[_], X, Y](implicit F: Zip[F],
                                 FF: Functor[F],
                                 afx: Arbitrary[F[X]],
                                 afy: Arbitrary[F[Y]],
                                 ef: Equal[F[X]]) =
  ...
  object contravariant
    def identity[F[_], X](
        implicit F: Contravariant[F], afx: Arbitrary[F[X]], ef: Equal[F[X]]) =
      forAll(F.contravariantLaw.identity[X] _)

    def composite[F[_], X, Y, Z](implicit F: Contravariant[F],
                                 af: Arbitrary[F[Z]],
                                 axy: Arbitrary[(X => Y)],
                                 ayz: Arbitrary[(Y => Z)],
                                 ef: Equal[F[X]]) =
    ...
    def laws[F[_]](implicit F: Contravariant[F],
                   af: Arbitrary[F[Int]],
                   axy: Arbitrary[(Int => Int)],
                   ef: Equal[F[Int]]): Properties =
  ...
  object divide
    def composition[F[_], A](
        implicit F: Divide[F], A: Arbitrary[F[A]], E: Equal[F[A]]) =
      forAll(F.divideLaw.composition[A] _)

    def laws[F[_]](implicit F: Divide[F],
                   af: Arbitrary[F[Int]],
                   axy: Arbitrary[Int => Int],
                   ef: Equal[F[Int]]): Properties =
  ...
  object divisible
    def rightIdentity[F[_], A](
        implicit F: Divisible[F], A: Arbitrary[F[A]], E: Equal[F[A]]) =
    ...
    def laws[F[_]](implicit F: Divisible[F],
                   af: Arbitrary[F[Int]],
                   axy: Arbitrary[Int => Int],
                   ef: Equal[F[Int]]): Properties =
  ...
  object compose
    def associative[=>:[_, _], A, B, C, D](implicit ab: Arbitrary[A =>: B],
                                           bc: Arbitrary[B =>: C],
                                           cd: Arbitrary[C =>: D],
                                           C: Compose[=>:],
                                           E: Equal[A =>: D]) =
    ...
    def laws[=>:[_, _]](implicit C: Compose[=>:],
                        AB: Arbitrary[Int =>: Int],
                        E: Equal[Int =>: Int]): Properties =
      newProperties("compose")  p =>
        p.property("associative") = associative[=>:, Int, Int, Int, Int]
        p.include(semigroup.laws[Int =>: Int](
                C.semigroup[Int], implicitly, implicitly))

  object category
    def leftIdentity[=>:[_, _], A, B](
        implicit ab: Arbitrary[A =>: B], C: Category[=>:], E: Equal[A =>: B]) =
    ...
    def laws[=>:[_, _]](implicit C: Category[=>:],
                        AB: Arbitrary[Int =>: Int],
                        E: Equal[Int =>: Int]): Properties =
  ...
  object associative
    def leftRight[=>:[_, _], X, Y, Z](implicit F: Associative[=>:],
                                      af: Arbitrary[X =>: (Y =>: Z)],
                                      ef: Equal[X =>: (Y =>: Z)]) =
      forAll(F.associativeLaw.leftRight[X, Y, Z] _)

    def rightLeft[=>:[_, _], X, Y, Z](implicit F: Associative[=>:],
                                      af: Arbitrary[(X =>: Y) =>: Z],
                                      ef: Equal[(X =>: Y) =>: Z]) =
  ...
  object monadError
    def raisedErrorsHandled[F[_], E, A](implicit me: MonadError[F, E],
                                        eq: Equal[F[A]],
                                        ae: Arbitrary[E],
                                        afea: Arbitrary[E => F[A]]) =
      forAll(me.monadErrorLaw.raisedErrorsHandled[A] _)
    def errorsRaised[F[_], E, A](implicit me: MonadError[F, E],
                                 eq: Equal[F[A]],
                                 ae: Arbitrary[E],
                                 aa: Arbitrary[A]) =
      forAll(me.monadErrorLaw.errorsRaised[A] _)
    def errorsStopComputation[F[_], E, A](implicit me: MonadError[F, E],
                                          eq: Equal[F[A]],
                                          ae: Arbitrary[E],
                                          aa: Arbitrary[A]) =
      forAll(me.monadErrorLaw.errorsStopComputation[A] _)

    def laws[F[_], E](implicit me: MonadError[F, E],
                      am: Arbitrary[F[Int]],
