...
trait RepositoryService { self: AccountService =>
      ...
      (Repositories filter { t =>
        ...
        CommitStatuses.insertAll(
            commitStatuses.map(_.copy(userName = newUserName,
                                      repositoryName = newRepositoryName)): _*)
        ProtectedBranches.insertAll(protectedBranches.map(
                _.copy(userName = newUserName,
                       repositoryName = newRepositoryName)): _*)
        ProtectedBranchContexts.insertAll(protectedBranchContexts.map(
                _.copy(userName = newUserName,
                       repositoryName = newRepositoryName)): _*)
  ...
  /**
    ...
    */
  def getVisibleRepositories(loginAccount: Option[Account],
  ...
  /**
    ...
    */
  def saveRepositoryOptions(userName: String,
...
object RepositoryService {
  ...
  case class RepositoryInfo(owner: String,
    ...
    /**
      ...
      */
    def this(repo: JGitUtil.RepositoryInfo,
             model: Repository,
             issueCount: Int,
             pullCount: Int,
             forkedCount: Int,
