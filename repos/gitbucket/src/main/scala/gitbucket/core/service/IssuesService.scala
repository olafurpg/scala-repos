...
trait IssuesService { self: AccountService =>
  ...
  /**
    ...
    */
  def countIssue(condition: IssueSearchCondition,
  ...
  /**
    ...
    */
  def countIssueGroupByLabels(owner: String,
                              repository: String,
  ...
  /** for api
    ...
    */
  def searchPullRequestByApi(condition: IssueSearchCondition,
                             offset: Int,
                             limit: Int,
  ...
  def updateMilestoneId(owner: String,
                        repository: String,
                        issueId: Int,
  ...
  def closeIssuesFromMessage(message: String,
    ...
    extractCloseId(message).foreach { issueId =>
      for {
        issue <- getIssue(owner, repository, issueId) if !issue.closed
      } {
        createComment(owner,
                      repository,
                      userName,
  ...
  def createReferComment(owner: String,
                         repository: String,
                         fromIssue: Issue,
                         message: String,
...
object IssuesService {
  ...
  case class IssueSearchCondition(labels: Set[String] = Set.empty,
  ...
  object IssueSearchCondition {
    ...
    private def param(request: HttpServletRequest,
                      name: String,
  ...
  case class CommitStatusInfo(count: Int,
                              successCount: Int,
  ...
  case class IssueInfo(issue: Issue,
                       labels: List[Label],
