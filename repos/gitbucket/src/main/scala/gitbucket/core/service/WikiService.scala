...
object WikiService {
  ...
  /**
    ...
    */
  case class WikiPageInfo(name: String,
                          content: String,
                          committer: String,
                          time: Date,
                          id: String)
  ...
  /**
    ...
    */
  case class WikiPageHistoryInfo(name: String,
                                 committer: String,
                                 message: String,
                                 date: Date)
...
trait WikiService {
  ...
  def createWikiRepository(loginAccount: Account,
                           owner: String,
  ...
  /**
    ...
    */
  def revertWikiPage(owner: String,
                     repository: String,
                     from: String,
                     to: String,
                     committer: Account,
  ...
  /**
    ...
    */
  def deleteWikiPage(owner: String,
                     repository: String,
                     pageName: String,
                     committer: String,
                     mailAddress: String,
