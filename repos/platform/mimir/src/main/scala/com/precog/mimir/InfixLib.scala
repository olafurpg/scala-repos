...
import bytecode.{
  BinaryOperationType, JNumberT, JBooleanT, JTextT, Library, Instructions
}
...
trait InfixLibModule[M[+ _]] extends ColumnarTableLibModule[M] {
  trait InfixLib extends ColumnarTableLib {
    import StdLib.{
      BoolFrom, DoubleFrom, LongFrom, NumFrom, StrFrom, doubleIsDefined,
      StrAndDateT, dateToStrCol
    }
