...
trait TimeZoneSpecs[M[+ _]]
  ...
  "changing time zones (homogenous case)" should {
    "change to the correct time zone" in {
      val input =
        Join(BuiltInFunction2Op(ChangeTimeZone),
             Cross(None),
    ...
    "not modify millisecond value" in {
      ...
      result2 must contain(1272505072599L,
                           1298286599165L,
                           1315327492848L,
                           1328976693394L,
                           1356712699430L)
    ...
    "work correctly for fractional zones" in {
      ...
      result2 must contain("2011-02-21T00:39:59.165-10:30",
  ...
  "changing time zones (heterogeneous case)" should {
    "change to the correct time zone" in {
      ...
      result2 must contain("2011-02-21T01:09:59.165-10:00",
                           "2012-02-11T06:11:33.394-10:00",
                           "2011-09-06T06:44:52.848-10:00",
                           "2010-04-28T15:37:52.599-10:00",
