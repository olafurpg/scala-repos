...
trait JoinOptimizerSpecs[M[+ _]]
  ...
  "join optimization" should {
    ...
    "eliminate naive cartesian products in less trivial object join cases" in {
      ...
      val conversionsData =
        dag.AbsoluteLoad(Const(CString("/conversions"))(line), JUniverseT)(
          line)
          ...
          Join(
            ...
            Join(
              ...
              Join(
                ...
                price)(line))(line),
            Join(WrapObject, Cross(Some(CrossRight)), value, clicksData)(
              line))(line),
          "key",
          "value",
          0)
              ...
              AddSortKey(
                Join(
                  ...
                  Join(
                    ...
                    key,
                    Join(DerefObject, Cross(None), users, userId)(line))(line),
                  Join(WrapObject, Cross(Some(CrossRight)), value, users)(
                    line))(line),
                "key",
                "value",
                0),
      ...
      val input =
        Filter(
          ...
          Join(
            ...
            Join(DerefObject, Cross(None), newMedals, name)(line))(line))(line)
