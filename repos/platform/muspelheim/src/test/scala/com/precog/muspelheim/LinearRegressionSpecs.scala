  ...
  "linear regression" should
    ...
    def testPredict(model: Map[String, SValue]) =
      model.keySet mustEqual Set(
          "fit", "confidenceInterval", "predictionInterval")
    ...
    "return precise regression results" in
      ...
      model must haveAllElementsLike
        case (ids, values) =>
          ids must haveSize(0)
          values mustEqual SObject(Map("model1" -> SObject(
                      Map("residualStandardError" -> SObject(
                          ...
                          "varianceCovarianceMatrix" -> SArray(Vector(
                                  SArray(Vector(SDecimal(0.029179094730367727),
                                                SDecimal(
                                                    0.000005132290591506178),
                                                SDecimal(
                                                    0.0012941789523089743),
                                                SDecimal(-4.641629704480576))),
                                  SArray(
                                      Vector(SDecimal(0.000005132290591506234),
                                             SDecimal(1.7232175428295578E-7),
                                             SDecimal(
                                                 0.0000026890467037135995),
                                             SDecimal(0.0014286230989684486))),
                                  SArray(
                                      Vector(SDecimal(0.0012941789523089743),
                          ...
                          "coefficients" -> SArray(
                              Vector(SObject(Map(
                                             "x1" -> SObject(
                                                 Map("estimate" -> SDecimal(
                                                         -0.000353609260803943),
                                                     "standardError" -> SDecimal(
                                                         0.0004151165550576799))),
                                             "x2" -> SObject(
                                                 Map("standardError" -> SDecimal(
                                                         0.03963546815108074),
                                                     "estimate" -> SDecimal(
                                                         0.058266092643983664))),
                                             "x3" -> SObject(
                                                 Map("standardError" -> SDecimal(
                                                         37.2780177420194),
                                                     "estimate" -> SDecimal(
                                                         -13.04059432806976))))),
                                     SObject(Map("estimate" -> SDecimal(
                                                     0.06398145974561122),
                                                 "standardError" -> SDecimal(
                                                     0.17081889453560964))))),
      ...
      predResults mustEqual Set(
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(0.2033781409054441),
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(-0.09168503550146807),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(0.41044957243898667),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(0.34350266219169356),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(0.3664477456323341),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(-0.29914967551765137),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(-0.022684748200555035),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(-0.23185255903279373),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(0.10434021762615728),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(-0.12491148621376584),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(0.07369191728264393),
                          "confidenceInterval" -> SArray(
                              Vector(SDecimal(-0.5673976301980359),
                                     SDecimal(0.7147814647633237))),
                          "predictionInterval" -> SArray(
                              Vector(SDecimal(-1.276677011015371),
                                     SDecimal(1.424060845580659))))))),
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(0.15981827006475147),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(-0.17753635730419182),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(Map("fit" -> SDecimal(
                                              -0.05314337388394709),
                                          "confidenceInterval" -> SArray(
                                              Vector(
                                                  SDecimal(
          ...
          SObject(
              Map(
                  "model1" -> SObject(
                      Map("fit" -> SDecimal(0.16098562305018183),
                          "confidenceInterval" -> SArray(
          ...
          SObject(
              Map("model1" -> SObject(
                      Map("fit" -> SDecimal(-0.009355951358066453),
                          "confidenceInterval" -> SArray(
          ...
          SObject(Map(
                  "model1" -> SObject(
                      Map("fit" -> SDecimal(0.023449692507401948),
                          "confidenceInterval" -> SArray(
          ...
          SObject(Map("model1" -> SObject(Map(
                          ...
                          "confidenceInterval" -> SArray(
                              Vector(
                                  SDecimal(-0.52151233487641), SDecimal(0.6005085387354628))),
                          "predictionInterval" -> SArray(
