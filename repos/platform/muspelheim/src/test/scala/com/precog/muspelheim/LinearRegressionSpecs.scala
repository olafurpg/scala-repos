...
trait LinearRegressionSpecs extends EvalStackSpecs {
  ...
  def checkFields(fields: Map[String, SValue]) = {
    val requiredFields = Set("coefficients",
                             "RSquared",
  ...
  "linear regression" should {
    ...
    "handle multiple indep vars, one of which is a constant" in {
      ...
      def testResult(resValues: Array[BigDecimal],
    ...
    def testPredict(model: Map[String, SValue]) = {
      model.keySet mustEqual Set("fit",
                                 "confidenceInterval",
                                 "predictionInterval")
          ...
          values mustEqual SObject(
            Map("model1" -> SObject(Map(
              ...
              "coefficients" -> SArray(Vector(
                SObject(Map(
                  "x1" -> SObject(
                    Map("estimate" -> SDecimal(-0.000353609260803943),
                        "standardError" -> SDecimal(0.0004151165550576799))),
                  "x2" -> SObject(
                    Map("standardError" -> SDecimal(0.03963546815108074),
                        "estimate" -> SDecimal(0.058266092643983664))),
                  "x3" -> SObject(
                    Map("standardError" -> SDecimal(37.2780177420194),
                        "estimate" -> SDecimal(-13.04059432806976)))
                )),
                SObject(Map("estimate" -> SDecimal(0.06398145974561122),
      ...
      predResults mustEqual Set(
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.29431560466544177),
                     SDecimal(0.7010718864763299))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.0851091500695673),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.5851022333835115),
                     SDecimal(0.4017321623805754))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.3785265042883241),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.13780702485772428),
                     SDecimal(0.9587061697356976))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-0.8983994376088162),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.15613475300076995),
                     SDecimal(0.8431400773841571))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-0.9457366411511546),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.23055994092248494),
                     SDecimal(0.9634554321871531))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-0.9635592515031257),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.7742788311824955),
                     SDecimal(0.17597948014719278))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.5790903574191737),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.4898668510205224),
                     SDecimal(0.4444973546194123))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.2996967104855732),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.6846724956403343),
                     SDecimal(0.22096737757474683))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.5036805071503851),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.16240567781368945),
                     SDecimal(0.37108611306600403))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.1137130683009206),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.5735350403390753),
                     SDecimal(0.3237120679115436))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.3952514123515578),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.5673976301980359),
                     SDecimal(0.7147814647633237))),
            "predictionInterval" -> SArray(Vector(SDecimal(-1.276677011015371),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.32431880487926934),
                     SDecimal(0.6439553450087723))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.1234935166648408),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.6672157676701567),
                     SDecimal(0.31214305306177303))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.4629492713361403),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.4396759324088084),
                     SDecimal(0.33338918464091427))),
            "predictionInterval" -> SArray(Vector(SDecimal(-1.302906492808298),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.7744700890718244),
                     SDecimal(0.14679958506541996))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.588466527213795),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.8258596856896088),
                     SDecimal(0.3267442333739561))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.5704000268068927),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.17900619990234334),
                     SDecimal(0.7560923694692102))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-0.9886032530470941),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.588435827141518),
                     SDecimal(0.16707501723300994))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.4577568234690235),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.543625794379431),
                     SDecimal(0.38356813871660156))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.355733567187771),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.2120317372092274),
                     SDecimal(0.5340029833095911))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.0846637600743971),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.12064440737692839),
                     SDecimal(0.553376596040011))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.0189785996245788),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.5430850388059062),
                     SDecimal(0.5243731360897733))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.3121863982741837),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.17818883336490904),
                     SDecimal(0.6435455462341879))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.0248240420829635),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.36960590484028055),
                     SDecimal(0.4165052898550844))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.2283462721889578),
        ...
        SObject(
          Map("model1" -> SObject(Map(
            ...
            "confidenceInterval" -> SArray(
              Vector(SDecimal(-0.52151233487641),
                     SDecimal(0.6005085387354628))),
            "predictionInterval" -> SArray(
              Vector(SDecimal(-1.2747443204678535),
