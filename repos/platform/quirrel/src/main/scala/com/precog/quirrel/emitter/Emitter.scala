...
trait Emitter
  ...
  private case class MarkFormal(name: Identifier, let: ast.Let)
      extends MarkType
  ...
  def emit(expr: Expr): Vector[Instruction] = {
    ...
    def emitCrossOrMatchState(left: EmitterState,
                              leftProv: Provenance,
                              right: EmitterState,
    ...
    def emitMapState(left: EmitterState,
                     leftProv: Provenance,
                     right: EmitterState,
                     rightProv: Provenance,
    ...
    def emitFilterState(left: EmitterState,
                        leftProv: Provenance,
                        right: EmitterState,
            ...
            val contextualDispatches: Map[Expr, Set[List[ast.Dispatch]]] =
              btraces.map {
                case (key, pairPaths) => {
                  ...
                  val innerDispatches = paths
                    .filter { _ contains expr }
                    .map { btrace =>
