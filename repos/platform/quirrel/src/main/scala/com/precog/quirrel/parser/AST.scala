...
trait AST extends Phases {
  ...
  object ast {
    ...
    final case class Let(loc: LineStream,
      ...
      private val _constraints =
        attribute[Set[ProvConstraint]](checkProvenance)
    ...
    final case class Solve(loc: LineStream,
    ...
    final case class MetaDescent(loc: LineStream,
                                 child: Expr,
                                 property: String)
        extends Expr
        with UnaryOp
    ...
    final case class Dispatch(loc: LineStream,
                              name: Identifier,
                              actuals: Vector[Expr])
        extends Expr
        with NaryOp {
