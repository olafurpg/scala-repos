        ...
        testEmit(
          ...
          """.stripMargin)(
            Vector(
                ...
                Map2Cross(DerefObject),
                Reduce(
                    BuiltInReduction(Reduction(Vector(), "stdDev", 0x2007))),
                PushNum("3"),
                Map2Cross(Mul),
                Map2Cross(Add),
                Map2Cross(Gt),
