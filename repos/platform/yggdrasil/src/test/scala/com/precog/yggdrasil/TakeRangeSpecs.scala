...
trait TakeRangeSpec[M[+ _]]
  ...
  def testTakeRange = {
    ...
    val expected =
      Stream(JObject(JField("value", JNum(12)) :: JField(
                     "key", JArray(JNum(2) :: Nil)) :: Nil),
             JObject(JField(
                     "value",
                     JObject(JField("baz", JBool(true)) :: Nil)) :: JField(
  ...
  def testTakeRangeAcrossSlices = {
    val data: Stream[JValue] =
      Stream(JObject(JField("value", JString("foo")) :: JField(
             ...
             JObject(JField(
                     ...
                     JObject(JField("baz", JBool(true)) :: Nil)) :: JField(
                     "key", JArray(JNum(3) :: Nil)) :: Nil),
             JObject(JField("value", JString("ack1")) :: JField(
                     "key", JArray(JNum(4) :: Nil)) :: Nil),
             JObject(JField("value", JString("ack2")) :: JField("key",
                                                                JArray(
                                                                    JNum(5) :: Nil)) :: Nil),
             JObject(JField("value", JString("ack3")) :: JField(
                     "key", JArray(JNum(6) :: Nil)) :: Nil),
             JObject(JField("value", JString("ack4")) :: JField(
                     "key", JArray(JNum(7) :: Nil)) :: Nil),
             JObject(JField("value", JString("ack5")) :: JField(
                     "key", JArray(JNum(8) :: Nil)) :: Nil))
    ...
    val expected =
      Stream(JObject(JField("value", JNum(12)) :: JField(
             ...
             JObject(JField("value", JString("ack1")) :: JField(
                     "key", JArray(JNum(4) :: Nil)) :: Nil),
             JObject(JField("value", JString("ack2")) :: JField(
                     "key", JArray(JNum(5) :: Nil)) :: Nil),
             JObject(JField("value", JString("ack3")) :: JField("key",
                                                                JArray(
                                                                    JNum(6) :: Nil)) :: Nil),
             JObject(JField("value", JString("ack4")) :: JField(
                     "key", JArray(JNum(7) :: Nil)) :: Nil))
  ...
  def testTakeRangeSecondSlice = {
    ...
    val expected = Stream(JObject(JField("value", JString("ack3")) :: JField(
                                  "key", JArray(JNum(6) :: Nil)) :: Nil),
                          JObject(JField("value", JString("ack4")) :: JField(
                                  "key", JArray(JNum(7) :: Nil)) :: Nil))
  ...
  def testTakeRangeFirstSliceOnly = {
    ...
    val expected = Stream(
        ...
        JObject(JField("value", JNum(12)) :: JField(
                "key", JArray(JNum(2) :: Nil)) :: Nil),
        JObject(JField("value", JObject(JField("baz", JBool(true)) :: Nil)) :: JField(
                "key", JArray(JNum(3) :: Nil)) :: Nil),
        JObject(JField("value", JString("ack1")) :: JField(
                "key", JArray(JNum(4) :: Nil)) :: Nil),
        JObject(JField("value", JString("ack2")) :: JField(
