      ...
      val grouping = GroupingAlignment(
        ...
        GroupingSource(
          ...
          GroupKeySpecOr(
            GroupKeySpecSource(
              oneField,
              DerefObjectStatic(DerefObjectStatic(Leaf(Source), valueField),
                                aField)),
            GroupKeySpecSource(
              twoField,
              DerefObjectStatic(DerefObjectStatic(Leaf(Source), valueField),
        ...
        GroupingSource(
          ...
          DerefObjectStatic(Leaf(Source), keyField),
          Some(
            InnerObjectConcat(ObjectDelete(Leaf(Source), Set(valueField)),
                              WrapObject(DerefObjectStatic(Leaf(Source),
                                                           valueField),
                                         "value"))),
          3,
          GroupKeySpecAnd(
