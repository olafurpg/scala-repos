...
import breeze.linalg.{
  *, axpy => Baxpy, sum => Bsum, DenseMatrix => BDM, DenseVector => BDV,
  Vector => BV
}
...
private[ann] class AffineLayerModel private (w: BDM[Double], b: BDV[Double])
  ...
  override def prevDelta(nextDelta: BDM[Double],
...
private[ann] trait ActivationFunction extends Serializable {
  ...
  /**
    ...
    */
  def crossEntropy(target: BDM[Double],
                   output: BDM[Double],
...
private[ann] class FunctionalLayerModel private (
  ...
  def crossEntropy(output: BDM[Double],
...
/**
  ...
  */
private[ml] class FeedForwardModel private (val layerModels: Array[LayerModel],
...
private[ann] object FeedForwardModel {
  ...
  /**
    ...
    * @return model
    */
  def apply(topology: FeedForwardTopology,
...
/**
  ...
  */
private[ml] class FeedForwardTrainer(topology: Topology,
                                     val inputSize: Int,
                                     val outputSize: Int)
    extends Serializable {
