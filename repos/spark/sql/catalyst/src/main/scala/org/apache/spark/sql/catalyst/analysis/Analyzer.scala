...
class Analyzer(catalog: Catalog,
  ...
  object ResolveGroupingAnalytics extends Rule[LogicalPlan] {
    ...
    def apply(plan: LogicalPlan): LogicalPlan = plan resolveOperators {
      ...
      case Aggregate(Seq(c @ Cube(groupByExprs)),
                     aggregateExpressions,
                     child) =>
        GroupingSets(bitmasks(c), groupByExprs, child, aggregateExpressions)
      case Aggregate(Seq(r @ Rollup(groupByExprs)),
                     aggregateExpressions,
                     child) =>
  ...
  object ResolveReferences extends Rule[LogicalPlan] {
    ...
    /**
      ...
      */
    def expandStarExpressions(exprs: Seq[Expression],
        ...
        .collect {
          ...
          case oldVersion @ Project(projectList, _)
              if findAliases(projectList)
                ...
                .nonEmpty =>
            (oldVersion,
             oldVersion.copy(projectList = newAliases(projectList)))
          ...
          case oldVersion @ Window(windowExpressions, _, _, child)
            ...
            (oldVersion,
             oldVersion.copy(
               windowExpressions = newAliases(windowExpressions)))
        }
    ...
    def apply(plan: LogicalPlan): LogicalPlan = plan resolveOperators {
      ...
      case o: ObjectOperator
        ...
        val deserializerToAttributes = o.deserializers
          .map {
  ...
  object ResolveSortReferences extends Rule[LogicalPlan] {
    ...
    /**
      ...
      * Aggregate.
      */
    private def addMissingAttr(plan: LogicalPlan,
      ...
      plan match {
        case p: Project =>
          ...
          Project(p.projectList ++ missingAttrs,
    ...
    /**
      ...
      */
    @tailrec
    private def resolveExpressionRecursively(expr: Expression,
  ...
  object ResolveGenerate extends Rule[LogicalPlan] {
    ...
    /**
      ...
      */
    private def makeGeneratorOutput(generator: Generator,
  ...
  object ExtractWindowExpressions extends Rule[LogicalPlan] {
    ...
    private def addWindow(expressionsWithWindowFunctions: Seq[NamedExpression],
      ...
      val groupedWindowExpressions = extractedWindowExprBuffer
        .groupBy { expr =>
          val distinctWindowSpec = expr
            .collect {
    ...
    override def apply(plan: LogicalPlan): LogicalPlan =
      plan resolveOperators {
        ...
        case j @ Join(left, right, NaturalJoin(joinType), condition)
          ...
          commonNaturalJoinProcessing(left,
                                      right,
                                      joinType,
                                      joinNames,
                                      condition)
