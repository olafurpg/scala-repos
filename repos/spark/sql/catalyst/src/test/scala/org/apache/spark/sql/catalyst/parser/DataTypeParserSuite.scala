...
class DataTypeParserSuite extends SparkFunSuite {
  ...
  checkDataType("Array<map<int, tinYint>>",
  ...
  checkDataType(
    ...
    StructType(
      StructField("intType", IntegerType, true) :: StructField("ts",
                                                               TimestampType,
                                                               true) :: Nil)
  )
  ...
  checkDataType(
    ...
    StructType(
      StructField("struct",
                  StructType(StructField("deciMal",
        ...
        true) :: StructField("arrAy", ArrayType(DoubleType, true), true) :: StructField(
        "anotherArray",
