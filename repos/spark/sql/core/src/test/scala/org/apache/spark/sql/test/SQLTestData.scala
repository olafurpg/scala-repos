...
private[sql] trait SQLTestData { self =>
      ...
      sqlContext.sparkContext
        .parallelize(
          LargeAndSmallInts(2147483644, 1) :: LargeAndSmallInts(1, 2) :: LargeAndSmallInts(
            2147483645,
            1) :: LargeAndSmallInts(2, 2) :: LargeAndSmallInts(2147483646, 1) :: LargeAndSmallInts(
            3,
            2) :: Nil)
        .toDF()
  ...
  protected lazy val mapData: RDD[MapData] = {
    val rdd =
      sqlContext.sparkContext.parallelize(MapData(
        Map(1 -> "a1", 2 -> "b1", 3 -> "c1", 4 -> "d1", 5 -> "e1")) :: MapData(
  ...
  protected lazy val allNulls: DataFrame = {
    val df =
      sqlContext.sparkContext
        .parallelize(NullInts(null) :: NullInts(null) :: NullInts(null) :: NullInts(
          null) :: Nil)
        .toDF()
  ...
  protected lazy val nullStrings: DataFrame = {
    val df = sqlContext.sparkContext
      .parallelize(NullStrings(1, "abc") :: NullStrings(2, "ABC") :: NullStrings(
        3,
        null) :: Nil)
      .toDF()
  ...
  protected lazy val unparsedStrings: RDD[String] = {
    sqlContext.sparkContext.parallelize(
      "1, A1, true, null" :: "2, B2, false, null" :: "3, C3, true, null" :: "4, D4, true, 2147483644" :: Nil)
  }
  ...
  protected lazy val courseSales: DataFrame = {
    val df = sqlContext.sparkContext
      .parallelize(CourseSales("dotNET", 2012, 10000) :: CourseSales(
        ...
        "dotNET",
        2013,
        48000) :: CourseSales("Java", 2013, 30000) :: Nil)
      .toDF()
