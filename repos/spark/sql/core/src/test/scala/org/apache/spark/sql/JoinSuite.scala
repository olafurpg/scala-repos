...
//  }
  ...
  test("left outer join") {
    ...
    checkAnswer(
        ...
        Row(1, "A", null, null) :: Row(2, "B", 2, "b") :: Row(3,
                                                              "C",
                                                              3,
                                                              "c") :: Row(
            4,
  ...
  test("right outer join") {
    ...
    checkAnswer(
        ...
        Row(null, null, 1, "A") :: Row(2, "b", 2, "B") :: Row(3,
                                                              "c",
                                                              3,
                                                              "C") :: Row(
            4,
    ...
    checkAnswer(
        lowerCaseData
          .join(upperCaseData, $"n" === $"N" && $"l" > $"L", "right"),
        Row(1, "a", 1, "A") :: Row(2, "b", 2, "B") :: Row(3, "c", 3, "C") :: Row(
            4,
            "d",
            4,
