...
class SparkConf(loadDefaults: Boolean) extends Cloneable with Logging {
  ...
  private[spark] def set(key: String,
                         value: String,
  ...
  private[spark] def set[T](entry: OptionalConfigEntry[T],
                            value: T): SparkConf = {
  ...
  private[spark] def setIfMissing[T](entry: ConfigEntry[T],
                                     value: T): SparkConf = {
  ...
  private[spark] def setIfMissing[T](entry: OptionalConfigEntry[T],
                                     value: T): SparkConf = {
