...
import org.apache.spark.scheduler.{
  AccumulableInfo, DirectTaskResult, IndirectTaskResult, Task
}
...
/**
  ...
  */
private[spark] class Executor(executorId: String,
  ...
  class TaskRunner(execBackend: ExecutorBackend,
                   val taskId: Long,
    ...
    override def run(): Unit = {
      ...
      try {
        ...
        case t: Throwable =>
          ...
          val accumulatorUpdates: Seq[AccumulableInfo] = if (task != null) {
