...
import org.apache.spark.network.client.{
  RpcResponseCallback, TransportClientBootstrap, TransportClientFactory
}
import org.apache.spark.network.sasl.{SaslClientBootstrap, SaslServerBootstrap}
import org.apache.spark.network.server._
import org.apache.spark.network.shuffle.{
  BlockFetchingListener, OneForOneBlockFetcher, RetryingBlockFetcher
}
...
class NettyBlockTransferService(conf: SparkConf,
  ...
  private def createServer(
    ...
    Utils
      .startServiceOnPort(portToTry, startService, conf, getClass.getName)
      ._1
  }
