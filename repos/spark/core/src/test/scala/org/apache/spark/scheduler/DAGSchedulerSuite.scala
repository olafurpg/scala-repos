...
class DAGSchedulerSuite
  ...
  private def submitMapStage(shuffleDep: ShuffleDependency[_, _, _],
  ...
  test("equals and hashCode AccumulableInfo") {
    val accInfo1 = new AccumulableInfo(1,
                                       Some("a1"),
                                       Some("delta1"),
                                       Some("val1"),
                                       internal = true,
                                       countFailedValues = false)
    val accInfo2 = new AccumulableInfo(1,
                                       Some("a1"),
                                       Some("delta1"),
                                       Some("val1"),
                                       internal = false,
                                       countFailedValues = false)
    val accInfo3 = new AccumulableInfo(1,
                                       Some("a1"),
                                       Some("delta1"),
                                       Some("val1"),
                                       internal = false,
  ...
  test(
    ...
    complete(taskSets(0),
             Seq((Success, makeMapStatus("hostA", 2)),
