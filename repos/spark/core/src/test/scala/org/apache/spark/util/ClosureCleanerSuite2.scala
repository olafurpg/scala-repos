...
class ClosureCleanerSuite2
  ...
  test("clean basic serializable closures")
    ...
    verifyCleaning(
        closure1, serializableBefore = true, serializableAfter = true)
    verifyCleaning(
        closure2, serializableBefore = true, serializableAfter = true)
    verifyCleaning(
        closure3, serializableBefore = true, serializableAfter = true)
    verifyCleaning(
        closure4, serializableBefore = true, serializableAfter = true)
    verifyCleaning(
        closure5, serializableBefore = true, serializableAfter = true)
  ...
  test("clean basic non-serializable closures")
    ...
    verifyCleaning(
        closure2, serializableBefore = false, serializableAfter = false)
    verifyCleaning(
        closure3, serializableBefore = false, serializableAfter = false)
    verifyCleaning(
  ...
  test("clean complicated nested non-serializable closures")
    ...
    val test1 = () =>
        ...
        verifyCleaning(
            inner1, serializableBefore = false, serializableAfter = false)
