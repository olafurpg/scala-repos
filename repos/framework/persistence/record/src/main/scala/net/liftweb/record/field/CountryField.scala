...
object Countries extends Enumeration(1)
  ...
  C262, C263, C264, C265, C266, C267, C268, C269, C270, C271, C272 =
    I18NCountry
...
class CountryField[OwnerType <: Record[OwnerType]](rec: OwnerType)
    extends EnumField(rec, Countries) {}

class OptionalCountryField[OwnerType <: Record[OwnerType]](rec: OwnerType)
    extends OptionalEnumField(rec, Countries) {}
