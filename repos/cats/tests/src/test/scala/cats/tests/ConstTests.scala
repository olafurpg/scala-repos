...
class ConstTests extends CatsSuite {
  ...
  checkAll("Const[String, Int]",
           CartesianTests[Const[String, ?]].cartesian[Int, Int, Int])
  checkAll("Cartesian[Const[String, ?]]",
  ...
  checkAll("Traverse[Const[String, ?]]",
  ...
  checkAll("Const[NonEmptyList[Int], String]",
  ...
  checkAll("Const[Map[Int, Int], String]",
           OrderLaws[Const[Map[Int, Int], String]].eqv)
  checkAll("PartialOrder[Const[Set[Int], String]]",
