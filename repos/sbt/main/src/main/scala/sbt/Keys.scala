...
object Keys
  ...
  val logLevel = SettingKey[Level.Value](
      "log-level", "The amount of logging sent to the screen.", ASetting)
  ...
  val persistTraceLevel = SettingKey[Int](
      "persist-trace-level", "The amount of stack trace persisted.", CSetting)
  ...
  val scalaSource = SettingKey[File](
      "scala-source", "Default Scala source directory.", ASetting)
  val javaSource =
  ...
  val managedSources = TaskKey[Seq[File]](
      "managed-sources", "Sources generated by the build.", BTask)
  val sources = TaskKey[Seq[File]](
      "sources", "All sources, both managed and unmanaged.", BTask)
  ...
  val managedResources = TaskKey[Seq[File]](
      "managed-resources", "Resources generated by the build.", BTask)
  ...
  val resources = TaskKey[Seq[File]](
      "resources", "All resource files, both managed and unmanaged.", BTask)
  ...
  val cleanKeepFiles = SettingKey[Seq[File]](
      "clean-keep-files", "Files to keep during a clean.", CSetting)
  ...
  val sourceGenerators = SettingKey[Seq[Task[Seq[File]]]](
      "source-generators", "List of tasks that generate sources.", CSetting)
  ...
  val scalacOptions = TaskKey[Seq[String]](
      "scalac-options", "Options for the Scala compiler.", BPlusTask)
  val javacOptions = TaskKey[Seq[String]](
      "javac-options", "Options for the Java compiler.", BPlusTask)
  val incOptions = TaskKey[IncOptions](
      "inc-options", "Options for the incremental compiler.", BTask)
  ...
  val compileInputs = TaskKey[Inputs](
      "compile-inputs", "Collects all inputs needed for compilation.", DTask)
  ...
  val scalaVersion = SettingKey[String](
      "scala-version", "The version of Scala used for building.", APlusSetting)
  ...
  val manipulateBytecode = TaskKey[CompileResult](
      "manipulateBytecode", "Manipulates generated bytecode", BTask)
  val compileIncremental = TaskKey[CompileResult](
      "compileIncremental", "Actually runs the incremental compilation", DTask)
  ...
  val aggregate = SettingKey[Boolean](
      "aggregate", "Configures task aggregation.", BMinusSetting)
  ...
  val packageBin = TaskKey[File](
      "package-bin", "Produces a main artifact, such as a binary jar.", ATask)
  ...
  val packageOptions = TaskKey[Seq[PackageOption]](
      "package-options", "Options for packaging.", BTask)
  ...
  val artifactPath = SettingKey[File](
      "artifact-path", "The location of a generated artifact.", BPlusSetting)
  val artifact =
  ...
  val selectMainClass = TaskKey[Option[String]](
      "select-main-class", "Selects the main class to run.", BMinusTask)
  ...
  val discoveredMainClasses = TaskKey[Seq[String]](
      "discovered-main-classes", "Auto-detects main classes.", BMinusTask)
  val runner = TaskKey[ScalaRun](
      "runner", "Implementation used to run a main class.", DTask)
  ...
  val javaOptions = TaskKey[Seq[String]](
      "java-options", "Options passed to a new JVM when forking.", BPlusTask)
  val envVars = TaskKey[Map[String, String]](
      "envVars", "Environment variables used when forking a new JVM", BTask)

  // Test Keys
  val testLoader = TaskKey[ClassLoader](
      "test-loader", "Provides the class loader used for testing.", DTask)
  ...
  val definedTests = TaskKey[Seq[TestDefinition]](
      "defined-tests", "Provides the list of defined tests.", BMinusTask)
  val definedTestNames = TaskKey[Seq[String]](
      "defined-test-names",
      "Provides the set of defined test names.",
      BMinusTask)
  val executeTests = TaskKey[Tests.Output](
      "execute-tests", "Executes all tests, producing a report.", CTask)
  ...
  val testOptions = TaskKey[Seq[TestOption]](
      "test-options", "Options for running tests.", BPlusTask)
  ...
  val testListeners = TaskKey[Seq[TestReportListener]](
      "test-listeners", "Defines test listeners.", DTask)
  ...
  val testExecution = TaskKey[Tests.Execution](
      "test-execution", "Settings controlling test execution", DTask)
  val testFilter = TaskKey[Seq[String] => Seq[String => Boolean]](
      "test-filter", "Filter controlling whether the test is executed", DTask)
  val testResultLogger = SettingKey[TestResultLogger](
      "test-result-logger", "Logs results after a test task completes.", DTask)
  ...
  val isModule = AttributeKey[Boolean](
      "is-module", "True if the target is a module.", DSetting)
  ...
  val scmInfo = SettingKey[Option[ScmInfo]](
      "scm-info", "Basic SCM information for the project.", BMinusSetting)
  ...
  val products = TaskKey[Seq[File]](
      "products", "Build products that get packaged.", BMinusTask)
  @deprecated(
      "This task is unused by the default project and will be removed.",
      "0.13.0")
  val productDirectories = TaskKey[Seq[File]](
      "product-directories", "Base directories of build products.", CTask)
  ...
  val evicted = TaskKey[EvictionWarning](
      "evicted", "Display detailed eviction warnings.", CTask)
  ...
  val pomExtra = SettingKey[NodeSeq](
      "pom-extra", "Extra XML to insert into the generated POM.", BSetting)
  val pomPostProcess = SettingKey[XNode => XNode](
      "pom-post-process", "Transforms the generated POM.", CSetting)
  ...
  val version = SettingKey[String](
      "version", "The version/revision of the current module.", APlusSetting)
  ...
  val useJCenter = SettingKey[Boolean](
      "use-jcenter", "Use JCenter as the default repository.", BSetting)
  ...
  val libraryDependencies = SettingKey[Seq[ModuleID]](
      "library-dependencies", "Declares managed dependencies.", APlusSetting)
  ...
  val allDependencies = TaskKey[Seq[ModuleID]](
      "all-dependencies", "Inter-project and library dependencies.", CTask)
  val projectDependencies = TaskKey[Seq[ModuleID]](
      "project-dependencies", "Inter-project dependencies.", DTask)
  ...
  val ivyLoggingLevel = SettingKey[UpdateLogging.Value](
      "ivy-logging-level", "The logging level for updating.", BSetting)
  val publishTo = SettingKey[Option[Resolver]](
      "publish-to", "The resolver to publish to.", ASetting)
  ...
  val tags = SettingKey[Seq[(Tags.Tag, Int)]](
      "tags", ConcurrentRestrictions.tagsKey.label, BSetting)
  ...
  val streams = TaskKey[TaskStreams](
      "streams", "Provides streams for logging and persisting data.", DTask)
  ...
  private[sbt] val executeProgress = SettingKey[State => TaskProgress](
      "executeProgress", "Experimental task execution listener.", DTask)
  private[sbt] val taskCancelStrategy =
    SettingKey[State => TaskCancellationStrategy](
        "taskCancelStrategy", "Experimental task cancellation handler.", DTask)
