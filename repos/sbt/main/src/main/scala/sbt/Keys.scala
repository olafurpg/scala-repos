...
object Keys {
  ...
  val managedSourceDirectories = SettingKey[Seq[File]](
    ...
    BSetting)
  val managedSources = TaskKey[Seq[File]]("managed-sources",
  ...
  val scalacOptions = TaskKey[Seq[String]]("scalac-options",
                                           ...
                                           BPlusTask)
  val javacOptions = TaskKey[Seq[String]]("javac-options",
                                          "Options for the Java compiler.",
                                          BPlusTask)
  val incOptions = TaskKey[IncOptions]("inc-options",
  ...
  val copyResources = TaskKey[Seq[(File, File)]](
    ...
    AMinusTask)
  val aggregate = SettingKey[Boolean]("aggregate",
  ...
  val discoveredMainClasses = TaskKey[Seq[String]](
    ...
    BMinusTask)
  val runner = TaskKey[ScalaRun]("runner",
  ...
  val isModule = AttributeKey[Boolean]("is-module",
  ...
  val startYear = SettingKey[Option[Int]]("start-year",
  ...
  val organizationName = SettingKey[String]("organization-name",
                                            "Organization full/formal name.",
                                            BMinusSetting)
  val organizationHomepage = SettingKey[Option[URL]]("organization-homepage",
  ...
  val developers = SettingKey[List[Developer]](
    ...
    BMinusSetting)
  val apiURL = SettingKey[Option[URL]]("api-url",
  ...
  val products = TaskKey[Seq[File]]("products",
  ...
  val update = TaskKey[UpdateReport](
    ...
    ATask)
  val evicted = TaskKey[EvictionWarning]("evicted",
  ...
  @deprecated("Implementation detail.", "0.13.1")
  def dummy[T: Manifest](name: String,
