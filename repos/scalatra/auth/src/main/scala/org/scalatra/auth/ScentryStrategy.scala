...
trait ScentryStrategy[UserType <: AnyRef] {
  ...
  /**
    ...
    */
  def beforeAuthenticate(implicit request: HttpServletRequest,
  ...
  /**
    ...
    */
  def beforeSetUser(user: UserType)(implicit request: HttpServletRequest,
                                    response: HttpServletResponse) {}

  /**
    * Perform stuff after setting the user in the session
    */
  def afterSetUser(user: UserType)(implicit request: HttpServletRequest,
                                   response: HttpServletResponse) {}

  /**
    * Perform stuff before fetching and serializing the user from session
    */
  def beforeFetch[IdType](userId: IdType)(implicit request: HttpServletRequest,
                                          response: HttpServletResponse) {}

  /**
    * Perform stuff after fetching and serializing the user from session
    */
  def afterFetch(user: UserType)(implicit request: HttpServletRequest,
                                 response: HttpServletResponse) {}

  /**
    * Perform stuff before logging the user out and invalidating the session
    */
  def beforeLogout(user: UserType)(implicit request: HttpServletRequest,
                                   response: HttpServletResponse) {}

  /**
    * Perform stuff after logging the user out and invalidating the session
    */
  def afterLogout(user: UserType)(implicit request: HttpServletRequest,
                                  response: HttpServletResponse) {}

  /**
    * Perform stuff when the request is unauthenticated and the strategy is valid
    */
  def unauthenticated()(implicit request: HttpServletRequest,
                        response: HttpServletResponse) {}
}
