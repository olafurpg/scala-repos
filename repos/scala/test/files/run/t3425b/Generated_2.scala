...
object Test {
  ...
  type R1_2 = (Any { val y: P }) with (Any {
  ...
  type R1_14 = (Any { val y: Q }) with (Any {
    val y: R forSome { type R <: P with Q }
  })
  ...
  type R1_23 = (Any { val y: Q }) with (C {
    val y: R forSome { type R <: P with Q }
  })
  type R2_23 = R1_23 { val y: (Q) with (R forSome { type R <: P with Q }) }
  type R1_24 = (Any { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: P
  })
  type R2_24 = R1_24 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_25 = (Any { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: Q
  })
  type R2_25 = R1_25 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_26 = (Any { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: R forSome { type R <: P with Q }
  })
  type R2_26 = R1_26 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
      type R <: P with Q
    })
  }
  type R1_27 = (Any { val y: R forSome { type R <: P with Q } }) with (A {
    val y: P
  })
  type R2_27 = R1_27 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_28 = (Any { val y: R forSome { type R <: P with Q } }) with (A {
    val y: Q
  })
  type R2_28 = R1_28 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_29 = (Any { val y: R forSome { type R <: P with Q } }) with (A {
    val y: R forSome { type R <: P with Q }
  })
  type R2_29 = R1_29 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_30 = (Any { val y: R forSome { type R <: P with Q } }) with (B {
    val y: P
  })
  type R2_30 = R1_30 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_31 = (Any { val y: R forSome { type R <: P with Q } }) with (B {
    val y: Q
  })
  type R2_31 = R1_31 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_32 = (Any { val y: R forSome { type R <: P with Q } }) with (B {
    val y: R forSome { type R <: P with Q }
  })
  type R2_32 = R1_32 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_33 = (Any { val y: R forSome { type R <: P with Q } }) with (C {
    val y: P
  })
  type R2_33 = R1_33 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_34 = (Any { val y: R forSome { type R <: P with Q } }) with (C {
    val y: Q
  })
  type R2_34 = R1_34 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_35 = (Any { val y: R forSome { type R <: P with Q } }) with (C {
    val y: R forSome { type R <: P with Q }
  })
  type R2_35 = R1_35 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_59 = (A { val y: Q }) with (C {
    val y: R forSome { type R <: P with Q }
  })
  type R2_59 = R1_59 { val y: (Q) with (R forSome { type R <: P with Q }) }
  type R1_60 = (A { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: P
  })
  type R2_60 = R1_60 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_61 = (A { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: Q
  })
  type R2_61 = R1_61 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_62 = (A { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: R forSome { type R <: P with Q }
  })
  type R2_62 = R1_62 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_63 = (A { val y: R forSome { type R <: P with Q } }) with (A {
    val y: P
  })
  type R2_63 = R1_63 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_64 = (A { val y: R forSome { type R <: P with Q } }) with (A {
    val y: Q
  })
  type R2_64 = R1_64 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_65 = (A { val y: R forSome { type R <: P with Q } }) with (A {
    val y: R forSome { type R <: P with Q }
  })
  type R2_65 = R1_65 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_66 = (A { val y: R forSome { type R <: P with Q } }) with (B {
    val y: P
  })
  type R2_66 = R1_66 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_67 = (A { val y: R forSome { type R <: P with Q } }) with (B {
    val y: Q
  })
  type R2_67 = R1_67 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_68 = (A { val y: R forSome { type R <: P with Q } }) with (B {
    val y: R forSome { type R <: P with Q }
  })
  type R2_68 = R1_68 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_69 = (A { val y: R forSome { type R <: P with Q } }) with (C {
    val y: P
  })
  type R2_69 = R1_69 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_70 = (A { val y: R forSome { type R <: P with Q } }) with (C {
    val y: Q
  })
  type R2_70 = R1_70 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_71 = (A { val y: R forSome { type R <: P with Q } }) with (C {
    val y: R forSome { type R <: P with Q }
  })
  type R2_71 = R1_71 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_95 = (B { val y: Q }) with (C {
    val y: R forSome { type R <: P with Q }
  })
  type R2_95 = R1_95 { val y: (Q) with (R forSome { type R <: P with Q }) }
  type R1_96 = (B { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: P
  })
  type R2_96 = R1_96 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_97 = (B { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: Q
  })
  type R2_97 = R1_97 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_98 = (B { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: R forSome { type R <: P with Q }
  })
  type R2_98 = R1_98 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_99 = (B { val y: R forSome { type R <: P with Q } }) with (A {
    val y: P
  })
  type R2_99 = R1_99 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_100 = (B { val y: R forSome { type R <: P with Q } }) with (A {
    val y: Q
  })
  type R2_100 = R1_100 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_101 = (B { val y: R forSome { type R <: P with Q } }) with (A {
    val y: R forSome { type R <: P with Q }
  })
  type R2_101 = R1_101 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_102 = (B { val y: R forSome { type R <: P with Q } }) with (B {
    val y: P
  })
  type R2_102 = R1_102 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_103 = (B { val y: R forSome { type R <: P with Q } }) with (B {
    val y: Q
  })
  type R2_103 = R1_103 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_104 = (B { val y: R forSome { type R <: P with Q } }) with (B {
    val y: R forSome { type R <: P with Q }
  })
  type R2_104 = R1_104 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_105 = (B { val y: R forSome { type R <: P with Q } }) with (C {
    val y: P
  })
  type R2_105 = R1_105 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_106 = (B { val y: R forSome { type R <: P with Q } }) with (C {
    val y: Q
  })
  type R2_106 = R1_106 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_107 = (B { val y: R forSome { type R <: P with Q } }) with (C {
    val y: R forSome { type R <: P with Q }
  })
  type R2_107 = R1_107 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_110 = (C { val y: P }) with (Any {
    val y: R forSome { type R <: P with Q }
  })
  ...
  type R1_122 = (C { val y: Q }) with (Any {
    val y: R forSome { type R <: P with Q }
  })
  ...
  type R1_131 = (C { val y: Q }) with (C {
    val y: R forSome { type R <: P with Q }
  })
  type R2_131 = R1_131 { val y: (Q) with (R forSome { type R <: P with Q }) }
  type R1_132 = (C { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: P
  })
  type R2_132 = R1_132 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_133 = (C { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: Q
  })
  type R2_133 = R1_133 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_134 = (C { val y: R forSome { type R <: P with Q } }) with (Any {
    val y: R forSome { type R <: P with Q }
  })
  type R2_134 = R1_134 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_135 = (C { val y: R forSome { type R <: P with Q } }) with (A {
    val y: P
  })
  type R2_135 = R1_135 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_136 = (C { val y: R forSome { type R <: P with Q } }) with (A {
    val y: Q
  })
  type R2_136 = R1_136 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_137 = (C { val y: R forSome { type R <: P with Q } }) with (A {
    val y: R forSome { type R <: P with Q }
  })
  type R2_137 = R1_137 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_138 = (C { val y: R forSome { type R <: P with Q } }) with (B {
    val y: P
  })
  type R2_138 = R1_138 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_139 = (C { val y: R forSome { type R <: P with Q } }) with (B {
    val y: Q
  })
  type R2_139 = R1_139 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_140 = (C { val y: R forSome { type R <: P with Q } }) with (B {
    val y: R forSome { type R <: P with Q }
  })
  type R2_140 = R1_140 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  type R1_141 = (C { val y: R forSome { type R <: P with Q } }) with (C {
    val y: P
  })
  type R2_141 = R1_141 { val y: (R forSome { type R <: P with Q }) with (P) }
  type R1_142 = (C { val y: R forSome { type R <: P with Q } }) with (C {
    val y: Q
  })
  type R2_142 = R1_142 { val y: (R forSome { type R <: P with Q }) with (Q) }
  type R1_143 = (C { val y: R forSome { type R <: P with Q } }) with (C {
    val y: R forSome { type R <: P with Q }
  })
  type R2_143 = R1_143 {
    val y: (R forSome { type R <: P with Q }) with (R forSome {
  ...
  def f24 = {
    val x = ((new ABC): (Any { val y: R forSome { type R <: P with Q } }) with (Any {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f25 = {
  ...
  def f27 = {
    val x = ((new ABC): (Any { val y: R forSome { type R <: P with Q } }) with (A {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f28 = {
  ...
  def f30 = {
    val x = ((new ABC): (Any { val y: R forSome { type R <: P with Q } }) with (B {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f31 = {
  ...
  def f33 = {
    val x = ((new ABC): (Any { val y: R forSome { type R <: P with Q } }) with (C {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f34 = {
  ...
  def f60 = {
    val x = ((new ABC): (A { val y: R forSome { type R <: P with Q } }) with (Any {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f61 = {
  ...
  def f63 = {
    val x = ((new ABC): (A { val y: R forSome { type R <: P with Q } }) with (A {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f64 = {
  ...
  def f66 = {
    val x = ((new ABC): (A { val y: R forSome { type R <: P with Q } }) with (B {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f67 = {
  ...
  def f69 = {
    val x = ((new ABC): (A { val y: R forSome { type R <: P with Q } }) with (C {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f70 = {
  ...
  def f96 = {
    val x = ((new ABC): (B { val y: R forSome { type R <: P with Q } }) with (Any {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f97 = {
  ...
  def f99 = {
    val x = ((new ABC): (B { val y: R forSome { type R <: P with Q } }) with (A {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f100 = {
  ...
  def f102 = {
    val x = ((new ABC): (B { val y: R forSome { type R <: P with Q } }) with (B {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f103 = {
  ...
  def f105 = {
    val x = ((new ABC): (B { val y: R forSome { type R <: P with Q } }) with (C {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f106 = {
  ...
  def f132 = {
    val x = ((new ABC): (C { val y: R forSome { type R <: P with Q } }) with (Any {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f133 = {
  ...
  def f135 = {
    val x = ((new ABC): (C { val y: R forSome { type R <: P with Q } }) with (A {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f136 = {
  ...
  def f138 = {
    val x = ((new ABC): (C { val y: R forSome { type R <: P with Q } }) with (B {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f139 = {
  ...
  def f141 = {
    val x = ((new ABC): (C { val y: R forSome { type R <: P with Q } }) with (C {
      val y: P
    })); x.y.reflected -> whatis(x).toString
  }
  def f142 = {
