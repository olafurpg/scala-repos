...
@serializable
@volatile
@serializable trait T4;

@serializable object O1 extends C1;
@serializable
@volatile object O2 extends C2;
@serializable
@volatile object O3 extends C3;
@serializable
@volatile
@serializable object O4 extends C4;
...
abstract class A1 {
  ...
  @serializable
  @volatile
  @serializable var y4: C4;

  @serializable def foo1: C1;
  @serializable
  @volatile def foo2: C2;
  @serializable
  @volatile def foo3: C3;
  @serializable
  @volatile
  @serializable def foo4: C4;
}
...
object O6 {
  ...
  @serializable
  @volatile var y2: C2 = _;
  @serializable
  @volatile var y3: C3 = _;
  @serializable
  @volatile
  @serializable var y4: C4 = _;

  @serializable private def foo1 = x1;
  @serializable
  @volatile private def foo2 = x2;
  @serializable
  @volatile protected def foo3 = x3;
  @serializable
  @volatile
  @serializable protected def foo4 = x4;
}
