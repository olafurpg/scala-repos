...
class ScalaVersionTest {
  ...
  def `version parses with rigor`() {
    ...
    assertEquals(
        V(2, 11, 7, Development("devbuild")), ScalaVersion("2.11.7-devbuild"))
    ...
    assertEquals(
        V(2, 11, 7, Development("RCCola")), ScalaVersion("2.11.7-RCCola"))
    assertEquals(
        V(2, 11, 7, Development("RC1.5")), ScalaVersion("2.11.7-RC1.5"))
    ...
    assertEquals(
        V(2, 11, 7, Development("final")), ScalaVersion("2.11.7-final"))
