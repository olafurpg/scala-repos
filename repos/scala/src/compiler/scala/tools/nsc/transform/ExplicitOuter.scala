...
abstract class ExplicitOuter
  ...
  private def haveSameOuter(parent: Type, clazz: Symbol) = {
    ...
    parentSym.isClass && owner.isClass && (owner
      .isSubClass(parentSym.owner)) &&
      ...
      tree match {
              ...
              case _ =>
                ...
                val vparamss1 =
                  if (isInner(clazz)) {
                    ...
                    val outerParam =
                      sym
                        .newValueParameter(nme.OUTER, sym.pos)
                        .setInfo(clazz.outerClass.thisType)
                    ((ValDef(outerParam)
                      .setType(NoType)) :: vparamss.head) :: vparamss.tail
                  } else vparamss
        ...
        case This(qual) =>
          if (sym == currentClass || sym.hasModuleFlag && sym.isStatic) tree
            ...
            atPos(tree.pos)(
              outerPath(outerValue, currentClass.outerClass, sym)) // (5)
