...
trait ScalaSettings
  ...
  val disable = MultiStringSetting("-Xplugin-disable",
                                   "plugin",
  ...
  val Ymacronoexpand =
    ...
    ).withDeprecationMessage(s"Use ${Ymacroexpand.name}:${MacroExpand.None}")
  ...
  val Yquasiquotedebug = BooleanSetting("-Yquasiquote-debug",
