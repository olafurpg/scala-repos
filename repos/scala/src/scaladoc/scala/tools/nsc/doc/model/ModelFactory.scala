...
class ModelFactory(val global: Global, val settings: doc.Settings) {
  ...
  abstract class MemberImpl(sym: Symbol, inTpl: DocTemplateImpl)
    ...
    def isAbstract =
      ...
      ((!sym.isTrait && ((sym hasFlag Flags.ABSTRACT) ||
                    (sym hasFlag Flags.DEFERRED)) && (!isImplicitlyInherited)) ||
  ...
  object modelCreation {
    ...
    def createLazyTemplateMember(aSym: Symbol,
      ...
      def createNoDocMemberTemplate(
        ...
        if (bSym.isModule ||
            (bSym.isAliasType && bSym.tpe.typeSymbol.isModule))
          new MemberTemplateImpl(bSym, inTpl)
          with Object {} else if (bSym.isTrait || (bSym.isAliasType &&
                                      bSym.tpe.typeSymbol.isTrait))
          new MemberTemplateImpl(bSym, inTpl)
          with Trait {} else if (bSym.isClass || (bSym.isAliasType &&
  ...
  def makeMember(aSym: Symbol,
    ...
    def makeMember0(bSym: Symbol,
      ...
      if (bSym.isGetter && bSym.isLazy)
        ...
        Some(new NonTemplateParamMemberImpl(cSym, conversion, useCaseOf, inTpl)
        ...
        if (conversion.isDefined || (bSym.enclClass.isAbstract &&
          ...
          Some(
              new NonTemplateParamMemberImpl(bSym,
                                             conversion,
                                             useCaseOf,
                                             inTpl) with Constructor {
        ...
        Some(new MemberTemplateImpl(bSym, inTpl) with TypeBoundsImpl
            with AbstractType {
          override def isAbstractType = true
        })
  ...
  def typeShouldDocument(bSym: Symbol, inTpl: DocTemplateImpl) =
    (settings.docExpandAllTypes && (bSym.sourceFile != null)) ||
      (bSym.isAliasType || bSym.isAbstractType) && {
        ...
        rawComment.contains("@template") || rawComment.contains(
            "@documentable")
      }
}
