...
private[collection] trait AugmentedIterableIterator[+T]
  ...
  def collect2combiner[S, That](pf: PartialFunction[T, S],
                                cb: Combiner[S, That]): Combiner[S, That] = {
    //val cb = pbf(repr)
  ...
  def take2combiner[U >: T, This](n: Int,
                                  cb: Combiner[U, This]): Combiner[U, This] = {
    cb.sizeHint(n)
    var left = n
    while (left > 0) {
  ...
  def drop2combiner[U >: T, This](n: Int,
                                  cb: Combiner[U, This]): Combiner[U, This] = {
    drop(n)
    if (isRemainingCheap) cb.sizeHint(remaining)
  ...
  def splitAt2combiners[U >: T, This](at: Int,
  ...
  def takeWhile2combiner[U >: T, This](p: T => Boolean,
                                       cb: Combiner[U, This]) = {
    var loop = true
    while (hasNext && loop) {
      val curr = next()
  ...
  def span2combiners[U >: T, This](p: T => Boolean,
                                   before: Combiner[U, This],
                                   after: Combiner[U, This]) = {
    var isBefore = true
  ...
  def scanToCombiner[U >: T, That](startValue: U,
                                   op: (U, U) => U,
                                   cb: Combiner[U, That]) = {
    var curr = startValue
    while (hasNext) {
  ...
  def scanToCombiner[U >: T, That](howmany: Int,
                                   startValue: U,
                                   op: (U, U) => U,
                                   cb: Combiner[U, That]) = {
    var curr = startValue
...
trait IterableSplitter[+T]
  ...
  def zipAllParSeq[S, U >: T, R >: S](that: SeqSplitter[S],
                                      thisElem: U,
                                      thatElem: R) =
...
trait SeqSplitter[+T]
  ...
  override def zipAllParSeq[S, U >: T, R >: S](that: SeqSplitter[S],
                                               thisElem: U,
                                               thatElem: R) =
    new ZippedAll[U, R](that, thisElem, thatElem)
