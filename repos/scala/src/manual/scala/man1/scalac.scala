...
object scalac extends Command {
        ...
        Definition(
          ...
          SeqPara(
            ...
            "The default class path is the current directory. Setting the " & Mono(
              "CLASSPATH") & " variable or using the " & Mono("-classpath") & " " & "command-line option overrides that default, so if you want to " & "include the current directory in the search path, you must " & "include " & Mono(
              "\".\"") & " in the new settings."
          )
        ),
  ...
  val examples =
    Section(
      ...
      DefinitionList(
        ...
        Definition(
          "Compile a Scala program using a user-defined " & MBold("java") & " " & "command",
  ...
  val seeAlso =
    Section(
      "SEE ALSO",
      Link(Bold("fsc") & "(1)", "fsc.html") & ", " & Link(Bold("scala") & "(1)",
                                                          "scala.html") & ", " & Link(
        Bold("scaladoc") & "(1)",
