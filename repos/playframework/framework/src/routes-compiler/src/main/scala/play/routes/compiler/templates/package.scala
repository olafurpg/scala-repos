...
package object templates {
  ...
  /**
    ...
    */
  def controllerMethodCall(r: Route,
  ...
  /**
    ...
    */
  def reverseMatchParameters(params: Seq[(Parameter, Int)],
  ...
  /**
    ...
    */
  def reverseParameterConstraints(route: Route,
  ...
  /**
    ...
    */
  def reverseLocalNames(route: Route,
