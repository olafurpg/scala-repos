  ...
  "CompositeX509TrustManager" should {
    ...
    "with checkClientTrusted" should {
      ...
      "throws exception" in {
        ...
        val trustManager =
          new CompositeX509TrustManager(trustManagers = Seq(mockTrustManager1,
                                                            mockTrustManager2),
                                        algorithmChecker)
        ...
        mockTrustManager1
          ...
          .throws(new CertificateException("fake1"))
        mockTrustManager2
          .checkClientTrusted(chain, authType)
          .throws(new CertificateException("fake2"))
    ...
    "getAcceptedIssuers" should {
      ...
      "throw exception when input exception" in {
        ...
        val trustManager =
          new CompositeX509TrustManager(trustManagers = Seq(mockTrustManager),
                                        algorithmChecker)
        mockTrustManager.getAcceptedIssuers.throws(
          new RuntimeException("fake"))
