  ...
  def evaluate(mf: Matrix2[Any, Any, Double]): BigInt = {
    ...
    def toProducts(mf: Matrix2[Any, Any, Double])
      ...
      mf match {
        ...
        case Product(leftp @ MatrixLiteral(_, _),
                     rightp @ MatrixLiteral(_, _),
                     _,
                     _) => {
          (Some(Product(leftp, rightp, ring)), Nil)
        }
        case Product(left @ Product(_, _, _, _),
        ...
        case Product(left @ MatrixLiteral(_, _),
    ...
    def labelTree(p: Matrix2[Any, Any, Double],
      ...
      p match {
        ...
        case Product(left @ MatrixLiteral(_, _),
          ...
          Some(
              new LabeledTree((start, labelRight.get.range._2),
                              None,
                              labelRight))
        }
        case Product(left @ Product(_, _, _, _),
    ...
    /**
      ...
      */
    def evaluateProduct(p: Matrix2[Any, Any, Double],
