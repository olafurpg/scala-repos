      ...
      val testcases =
        (t1.globify(DateRange("2011-12-01T14", "2011-12-04")),
         List(
             ...
             "/2011/12/02/*",
             "/2011/12/03/*",
             "/2011/12/04/00")) :: (t1.globify(DateRange("2011-12-01",
                                                         "2011-12-01T23:59")),
                                    List("/2011/12/01/*")) :: (t1.globify(
                                                                   DateRange(
                                                                       "2014-06-30T00",
                                                                       "2014-07-01T00")),
                                                               List(
                                                                   "/2014/06/30/*",
                                                                   "/2014/07/01/00")) :: (t1.globify(
                                                                                              DateRange(
                                                                                                  "2011-12-01T12",
                                                                                                  "2011-12-01T12:59")),
                                                                                          List(
                                                                                              "/2011/12/01/12")) :: (t1.globify(
                                                                                                                         DateRange(
                                                                                                                             "2011-12-01T12",
                                                                                                                             "2011-12-01T14")),
                                                                                                                     List(
                                                                                                                         "/2011/12/01/12",
                                                                                                                         "/2011/12/01/13",
                                                                                                                         "/2011/12/01/14")) :: (t2.globify(DateRange(
                                                                                                                                                        "2011-12-01T14",
                                                                                                                                                        "2011-12-04")),
                                                                                                                                                List(
                                                                                                                                                    "/2011/12/01/",
                                                                                                                                                    "/2011/12/02/",
                                                                                                                                                    "/2011/12/03/",
                                                                                                                                                    "/2011/12/04/")) :: (t2.globify(
                                                                                                                                                                             DateRange("2011-12-01",
                                                                                                                                                                                       "2011-12-01T23:59")),
                                                                                                                                                                         List(
                                                                                                                                                                             "/2011/12/01/")) :: (t2.globify(
                                                                                                                                                                                                      DateRange(
                                                                                                                                                                                                          "2011-12-01T12",
                                                                                                                                                                                                          "2011-12-01T12:59")),
                                                                                                                                                                                                  List("/2011/12/01/")) :: (t2.globify(
                                                                                                                                                                                                                                DateRange(
                                                                                                                                                                                                                                    "2011-12-01T12",
                                                                                                                                                                                                                                    "2012-01-02T14")),
                                                                                                                                                                                                                            List(
                                                                                                                                                                                                                                "/2011/12/*/",
                                                                                                                                                                                                                                "/2012/01/01/",
                                                                                                                                                                                                                                "/2012/01/02/")) :: (t2.globify(DateRange(
                                                                                                                                                                                                                                                             "2011-11-01T12",
                                                                                                                                                                                                                                                             "2011-12-02T14")),
                                                                                                                                                                                                                                                     List("/2011/11/*/",
                                                                                                                                                                                                                                                          "/2011/12/01/",
