...
case class BoxedOrderedSerialization[K](
    box: K => Boxed[K], ord: OrderedSerialization[K])
...
object Boxed
  ...
  private[this] val allBoxes = List(
    ...
    ( t: Any =>
          new Boxed244(t) , classOf[Boxed244[Any]]),
      ( t: Any =>
        new Boxed245(t)
  ...
  private[this] val boxes: AtomicReference[List[(Any => Boxed[Any], Class[
              _ <: Boxed[Any]])]] = new AtomicReference(allBoxes)
  ...
  private[this] val boxedCache = new java.util.concurrent.ConcurrentHashMap[
      AnyRef, (Any => Boxed[Any], Class[Boxed[Any]])]()
