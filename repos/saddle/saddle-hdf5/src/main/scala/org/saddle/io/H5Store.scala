...
object H5Store {
  ...
  /**
    ...
    */
  def readSeries[X: ST: ORD, T: ST](path: String,
  ...
  /**
    ...
    * @tparam T Series values type
    */
  def readSeriesSlice[X: ST: ORD, T: ST](path: String,
                                         group: String,
                                         from: X,
                                         to: X,
  ...
  /**
    ...
    * @tparam T Series values type
    */
  def readSeriesSlice[X: ST: ORD, T: ST](fileid: Int,
                                         group: String,
                                         from: X,
                                         to: X,
                                         inclusive: Boolean): Series[X, T] =
  ...
  /**
    ...
    * @tparam T Series values type
    */
  def writeSeries[X: ST: ORD, T: ST](path: String,
                                     group: String,
                                     s: Series[X, T]) {
    withMonitor {
  ...
  /**
    ...
    */
  def writeFrame[R: ST: ORD, C: ST: ORD, T: ST](path: String,
                                                group: String,
                                                df: Frame[R, C, T]) {
    withMonitor {
  ...
  /**
    ...
    * @tparam T Series values type
    */
  def writeSeries[X: ST: ORD, T: ST](fileid: Int,
                                     group: String,
                                     s: Series[X, T]) {
    withMonitor {
  ...
  /**
    ...
    * @tparam T Framevalues type
    */
  def writeFrame[R: ST: ORD, C: ST: ORD, T: ST](fileid: Int,
                                                group: String,
                                                df: Frame[R, C, T]) {
    withMonitor {
  ...
  private def writePandasSeries[X: ST, T: ST](file: String,
                                              name: String,
                                              index: Index[X],
                                              values: Array[T]): Int = {
  ...
  private def writePandasSeries[X: ST, T: ST](fileid: Int,
                                              group: String,
                                              index: Index[X],
                                              values: Array[T]): Int = {
    assertException(fileid >= 0,
