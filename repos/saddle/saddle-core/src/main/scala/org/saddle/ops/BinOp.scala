...
object BinOp {
  ...
  implicit val orLL: BLLL[BitOr] =
    new BinOpImpl[BitOr, Long, Long, Long](_ | _)
  ...
  implicit val divII: BIII[Divide] =
    new BinOpImpl[Divide, Int, Int, Int](_ / _)
  implicit val subII: BIII[Subtract] =
    new BinOpImpl[Subtract, Int, Int, Int](_ - _)
  implicit val andII: BIII[BitAnd] =
    new BinOpImpl[BitAnd, Int, Int, Int](_ & _)
  implicit val orII: BIII[BitOr] = new BinOpImpl[BitOr, Int, Int, Int](_ | _)
  implicit val xorII: BIII[BitXor] =
    new BinOpImpl[BitXor, Int, Int, Int](_ ^ _)
