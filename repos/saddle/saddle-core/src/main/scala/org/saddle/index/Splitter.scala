...
object Splitter
  ...
  implicit def split5th[T1 : ST : ORD,
                        T2 : ST : ORD,
                        T3 : ST : ORD,
                        T4 : ST : ORD,
                        T5 : ST : ORD] =
  ...
  implicit def split6th[T1 : ST : ORD,
                        T2 : ST : ORD,
                        T3 : ST : ORD,
                        T4 : ST : ORD,
                        T5 : ST : ORD,
  ...
  implicit def split7th[T1 : ST : ORD,
                        T2 : ST : ORD,
                        T3 : ST : ORD,
                        T4 : ST : ORD,
                        T5 : ST : ORD,
  ...
  implicit def split8th[T1 : ST : ORD,
                        T2 : ST : ORD,
                        T3 : ST : ORD,
                        T4 : ST : ORD,
                        T5 : ST : ORD,
  ...
  implicit def split9th[T1 : ST : ORD,
                        T2 : ST : ORD,
                        T3 : ST : ORD,
                        T4 : ST : ORD,
                        T5 : ST : ORD,
