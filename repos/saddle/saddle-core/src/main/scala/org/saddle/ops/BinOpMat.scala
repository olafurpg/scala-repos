...
trait BinOpMat {
  ...
  final class MatSclrElemOp[OP <: ScalarOp, @spec(Int, Long, Double) A, @spec(
          Int, Long, Double) B, @spec(Int, Long, Double) C: ST](
  ...
  final class MatMatElemOp[OP <: ScalarOp, @spec(Int, Long, Double) A, @spec(
          Int, Long, Double) B, @spec(Int, Long, Double) C: ST](
      op: BinOp[OP, A, B, C])
