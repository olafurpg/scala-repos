...
trait BinOpMat {
  ...
  implicit def matmulOpWithVector[A, B, OP <: InnerProd](implicit cb: ST[B],
                                                         na: NUM[A],
                                                         nb: NUM[B]) =
  ...
  implicit def vecmulOpWithMatrix[A, B, OP <: InnerProd](implicit cb: ST[A],
                                                         na: NUM[A],
                                                         nb: NUM[B]) =
  ...
  implicit def matmulOpWithMatrix[A, B, OP <: InnerProd](implicit cb: ST[B],
                                                         na: NUM[A],
                                                         nb: NUM[B]) =
