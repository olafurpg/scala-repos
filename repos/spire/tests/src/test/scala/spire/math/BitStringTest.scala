...
class BitStringTest extends SpireTests {
  ...
  test("BitString[Short]") {
    ...
    testCases(
        I(h"0", 0, h"0", h"0", 16, 16) :: I(h"7", 3, h"4", h"1", 13, 0) :: I(
            ...
            h"1",
            1,
            0) :: I(h"-32768", 1, h"-32768", h"-32768", 0, 15) :: I(h"-1",
                                                                    16,
                                                                    h"32768",
                                                                    h"1",
                                                                    0,
  ...
  test("BitString[Long]") {
    testCases(I(0L, 0, 0L, 0L, 64, 64) :: I(7L, 3, 4L, 1L, 61, 0) :: I(62L,
                                                                       5,
                                                                       32L,
                                                                       2L,
                                                                       58,
        ...
        1L,
        57,
        0) :: I(128L, 1, 128L, 128L, 56, 7) :: I(255L, 8, 128L, 1L, 56, 0) :: I(
        256L,
        1,
        256L,
        256L,
        ...
        1L,
        48,
        0) :: I(293859800L, 14, 268435456L, 8L, 35, 3) :: I(2147483647L,
                                                            31,
                                                            1073741824L,
                                                            1L,
                                                            33,
        ...
        2147483648L,
        32,
        31) :: I(4294967295L, 32, 2147483648L, 1L, 32, 0) :: Nil)
  }
