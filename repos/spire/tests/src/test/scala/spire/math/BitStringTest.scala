...
class BitStringTest extends SpireTests {
  ...
  test("BitString[Int]") {
    testCases(I(0, 0, 0, 0, 32, 32) :: I(7, 3, 4, 1, 29, 0) :: I(
            ...
            1,
            17,
            0) :: I(65535, 16, 32768, 1, 16, 0) :: I(
            65535,
            16,
            32768,
            1,
            16,
            0) :: I(293859800, 14, 268435456, 8, 3, 3) :: I(2147483647,
                                                            31,
                                                            1073741824,
                                                            1,
                                                            1,
  ...
  test("BitString[Long]") {
    testCases(
        I(0L, 0, 0L, 0L, 64, 64) :: I(7L, 3, 4L, 1L, 61, 0) :: I(
            ...
            1L,
            56,
            0) :: I(256L, 1, 256L, 256L, 55, 8) :: I(
            23985L,
            9,
            16384L,
            1L,
            49,
            0) :: I(32767L, 15, 16384L, 1L, 49, 0) :: I(
            65535L,
            16,
            32768L,
            1L,
            ...
            8L,
            35,
            3) :: I(2147483647L, 31, 1073741824L, 1L, 33, 0) :: I(
            2147483648L,
            1,
            2147483648L,
            2147483648L,
