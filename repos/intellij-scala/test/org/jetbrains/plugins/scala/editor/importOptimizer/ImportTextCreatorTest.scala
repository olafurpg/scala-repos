...
class ImportTextCreatorTest extends TestCase
  ...
  def testGetImportText_Root_And_Wildcard(): Unit =
    val info = ImportInfo("scala.collection",
                          ...
                          hasWildcard = true,
                          rootUsed = true)
    Assert.assertEquals("import _root_.scala.collection._",
  ...
  def testGetImportText_Hidden(): Unit =
    val info = ImportInfo("scala",
                          ...
                          hasWildcard = false,
                          rootUsed = false)
    Assert.assertEquals("import scala.{Long => _}",
                        textCreator.getImportText(info,
                                                  isUnicodeArrow = false,
                                                  spacesInImports = false,
                                                  sortLexicografically = true))
  ...
  def testGetImportText_Renames(): Unit =
    val info = ImportInfo("java.lang",
                          ...
                          hasWildcard = false,
                          rootUsed = false)
    Assert.assertEquals("import java.lang.{Long => JLong}",
                        textCreator.getImportText(info,
                                                  isUnicodeArrow = false,
                                                  spacesInImports = false,
                                                  sortLexicografically = true))
  ...
  def testGetImportText_SortSingles(): Unit =
    val info = ImportInfo("java.lang",
                          None,
                          Set.empty,
                          Set("Long", "Integer", "Float", "Short"),
                          Map.empty,
                          Set.empty,
                          hasWildcard = false,
                          rootUsed = false)
    Assert.assertEquals("import java.lang.{Float, Integer, Long, Short}",
                        textCreator.getImportText(info,
                                                  isUnicodeArrow = false,
                                                  spacesInImports = false,
                                                  sortLexicografically = true))
  ...
  def testGetImportText_Renames_Hidden_Singles_Wildcard_Spaces(): Unit =
    val info = ImportInfo("java.lang",
                          None,
                          Set.empty,
                          Set("Integer", "Character", "Runtime"),
                          Map("Long" -> "JLong", "Float" -> "JFloat"),
                          Set("System"),
                          hasWildcard = true,
                          rootUsed = false)
    Assert.assertEquals(
