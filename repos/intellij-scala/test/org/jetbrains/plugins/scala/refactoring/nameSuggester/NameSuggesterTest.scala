...
class NameSuggesterTest extends ScalaLightCodeInsightFixtureTestAdapter {
  ...
  def testCollections() {
    ...
    testNamesByType("scala.collection.immutable.Vector[String]",
                    Seq("strings", "vector"))
    testNamesByType("scala.collection.SeqLike[String]",
  ...
  def testSpecial() {
    ...
    testNamesByType("scala.concurrent.Future[String]",
                    Seq("eventualString", "future"))
    testNamesByType("scala.concurrent.Promise[String]",
                    Seq("promisedString", "promise"))
    testNamesByType("scala.util.Try[String]", Seq("triedString"))
    testNamesByType("scala.util.Either[Int, String]",
