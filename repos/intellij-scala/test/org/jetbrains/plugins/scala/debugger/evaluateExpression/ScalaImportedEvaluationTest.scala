...
abstract class ScalaImportedEvaluationTestBase extends ScalaDebuggerTestCase {
  addFileWithBreakpoints("ImportFromObject.scala", s"""
       ...
       |}
    """.stripMargin.trim())
  addFileWithBreakpoints("test/Stuff.scala", s"""
       |package test
       |object Stuff {
       |  val x = 0
       |  def foo() = "foo"
  ...
  addFileWithBreakpoints("ImportFromPackageObject.scala", s"""
       ...
       |}
    """.stripMargin.trim())
  addFileWithBreakpoints("test/stuff/package.scala", s"""
       |package test
  ...
  addFileWithBreakpoints("StopInsidePackageObject.scala", s"""
  ...
  addFileWithBreakpoints("StopInsideClassInPackageObject.scala", s"""
  ...
  addFileWithBreakpoints("StopInsideValueClass.scala", s"""
  ...
  addFileWithBreakpoints("ImportVal.scala", s"""
       |object ImportVal {
       |  def main(args: Array[String]) {
       |    val a = new A(0)
       |    import a._
  ...
  addFileWithBreakpoints("ImportProjectionType.scala", s"""
  ...
  addFileWithBreakpoints("ImportJava.scala", s"""
       |object ImportJava {
       |  def main(args: Array[String]) {
       ...
       |}
    """.stripMargin.trim())
  addFileWithBreakpoints("test/JavaClass.java", s"""
       |package test;
       |
  ...
  addFileWithBreakpoints("implicits/package.scala", s"""
       ...
       |}
    """.stripMargin.trim)
  addFileWithBreakpoints("ImportedImplicits.scala", s"""
       |import implicits._
  ...
  addFileWithBreakpoints("ImportedFromOuterThis.scala", s"""
