...
class NestedStatefulMonadsInspectionTest
  ...
  def test_1(): Unit = {
    val text = """import scala.util.Try
        |Try {}"""
    checkTextHasNoErrors(text)
  }

  def test_2(): Unit = {
    val text = """import scala.concurrent.Future
        |Future {}"""
    checkTextHasNoErrors(text)
  }

  def test_3(): Unit = {
    val text = s"""import scala.util.Try
        |${START}Try { Try {} }$END"""
    check(text)
  }

  def test_4(): Unit = {
    val text = s"""import scala.concurrent.Future
  ...
  def test_7(): Unit = {
    val text = s"""import scala.util._
