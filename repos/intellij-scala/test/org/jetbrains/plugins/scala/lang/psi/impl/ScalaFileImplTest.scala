...
//  }
  ...
  def testSplitsIn() {
    ...
    assertSplitsAre(List(List("a"), List("b"), List("c")),
  ...
  def testSplitAt() {
    ...
    assertSplitAs(List(List("a"), List("b")),
                  List(),
                  List(List("a"), List("b")))
    assertSplitAs(List(List("a"), List("b")),
                  List("a"),
...
//  }
  ...
  private def assertSplitsAre(path: List[List[String]],
                              vectors: List[List[String]]) {
    Assert.assertEquals(vectors, ScalaFileImpl.splitsIn(path))
  }

  private def assertPackageNameSetAs(before: String,
                                     name: (String, String),
                                     after: String) {
