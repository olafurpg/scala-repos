...
trait Specs2_2_11_3_1_M_Base extends Specs2TestCase {
  ...
  override protected def addOtherLibraries(): Unit = {
    ...
    addIvyCacheLibrary("specs2-core",
                       "org.specs2/specs2-core_2.11/jars",
                       "specs2-core_2.11-3.0.1.jar")
    addIvyCacheLibrary("specs2-matcher",
