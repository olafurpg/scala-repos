...
class Scalatest2_10_1_9_2_SelectedTestsTest extends {
  ...
  override val flatSpecTestPath = List(
      "[root]", "A FlatSpecTest should be able to run single test")
  override val freeSpecPathTestPath = List(
      "[root]", "A FreeSpecTest should be able to run single test")
  override val freeSpecTestPath = List(
      "[root]", "A FreeSpecTest should be able to run single tests")
  override val funSpecTestPath = List(
      "[root]", "FunSpecTest should launch single test")
