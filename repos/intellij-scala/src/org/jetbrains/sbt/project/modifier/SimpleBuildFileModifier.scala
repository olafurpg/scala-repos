...
object SimpleBuildFileModifier {
  ...
  def removeElementFromBuildFile(
    ...
    locationProvider.getModifyOrRemoveElement(module,
                                              elementType,
                                              elementCondition,
                                              buildFile) match {
      case Some(element) =>
