...
object MapGetOrElse extends SimplificationType() {
  ...
  def replacementText(qual: ScExpression,
                      mapArg: ScExpression,
  ...
  def checkTypes(qual: ScExpression,
                 mapArg: ScExpression,
    ...
    ScalaPsiElementFactory.createExpressionFromText(replacementText,
  ...
  def checkTypes(optionalBase: Option[ScExpression],
