...
class ScalaDocumentationProvider extends CodeDocumentationProvider {
  ...
  def getDocumentationElementForLookupItem(psiManager: PsiManager,
                                           obj: Object,
  ...
  def getDocumentationElementForLink(psiManager: PsiManager,
                                     link: String,
      ...
      case clazz: ScTypeDefinition =>
        ...
        clazz match {
          case par: ScParameterOwner =>
            buffer.append(
                parseParameters(par, ScType.urlText, end - start - 7))
          case _ =>
        }
        buffer.append("\n")
      ...
      case typez: ScTypeAlias =>
        ...
        typez match {
          case definition: ScTypeAliasDefinition =>
            buffer.append(" = " + ScType.urlText(definition.aliasedTypeElement
...
object ScalaDocumentationProvider {
  ...
  private def parseParameterClause(elem: ScParameterClause,
                                   typeToString: ScType => String,
                                   spaces: Int): String = {
    val buffer: StringBuilder = new StringBuilder(" ")
  ...
  def parseParameter(param: ScParameter,
                     typeToString: ScType => String,
