...
import com.intellij.psi.{
  PsiDocumentManager, PsiElement, PsiFile, PsiWhiteSpace
}
import org.jetbrains.plugins.scala.lang.psi.api.statements.{
  ScTypeAlias, ScVariable, ScFunction, ScValue
}
...
import org.jetbrains.plugins.scala.lang.lexer.{
  ScalaTokenTypes, ScalaXmlTokenTypes
}
...
import org.jetbrains.plugins.scala.lang.psi.api.expr.{
  ScArgumentExprList, ScIfStmt, ScReferenceExpression
}
...
class ScalaTypedHandler extends TypedHandlerDelegate {
  ...
  override def beforeCharTyped(c: Char,
                               project: Project,
                               editor: Editor,
                               file: PsiFile,
  ...
  private def isInPlace(element: PsiElement,
  ...
  private def completeScalaDocBoldSyntaxElement(document: Document,
                                                project: Project,
                                                element: PsiElement,
                                                offset: Int) {
    if (element.getNode.getElementType
  ...
  private def completeInterpolatedStringBraces(document: Document,
                                               project: Project,
                                               element: PsiElement,
                                               offset: Int) {
    if (element == null) return
  ...
  private def completeXmlAttributeQuote(editor: Editor)(document: Document,
                                                        project: Project,
                                                        element: PsiElement,
                                                        offset: Int) {
    if (element != null &&
  ...
  private def completeMultilineString(editor: Editor,
                                      project: Project,
                                      element: PsiElement,
                                      offset: Int) {
    extensions.inWriteAction {
  ...
  private def insertAndCommit(offset: Int,
                              text: String,
                              document: Document,
                              project: Project) {
    extensions.inWriteAction {
  ...
  private def indentCase(file: PsiFile)(document: Document,
                                        project: Project,
                                        element: PsiElement,
                                        offset: Int) {
    indentElement(file)(
  ...
  private def indentElse(file: PsiFile)(document: Document,
                                        project: Project,
                                        element: PsiElement,
                                        offset: Int) {
    indentElement(file)(
  ...
  private def indentRefExprDot(file: PsiFile)(document: Document,
                                              project: Project,
                                              element: PsiElement,
                                              offset: Int) = {
    indentElement(file)(
  ...
  private def scheduleAutopopup(file: PsiFile,
                                editor: Editor,
  ...
  private def startAutopopupCompletionInInterpolatedString(file: PsiFile,
                                                           editor: Editor)(
      document: Document,
      project: Project,
      element: PsiElement,
  ...
  private def completeEmptyXmlTag(editor: Editor)(document: Document,
                                                  project: Project,
                                                  element: PsiElement,
                                                  offset: Int) {
    if (element != null &&
