...
object TypeConstruction {
  def createStringTypePresentation(inType: PsiType,
...
case class ParametrizedConstruction(iNode: IntermediateNode,
...
case class TypeParameterConstruction(name: String,
