...
trait ParametersAnnotator {
  ...
  def annotateParameters(parameters: ScParameters,
  ...
  def annotateParameter(parameter: ScParameter,
                        holder: AnnotationHolder): Unit = {
  ...
  private def annotateCallByNameParameter(parameter: ScParameter,
