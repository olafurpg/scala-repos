...
import org.jetbrains.plugins.scala.lang.psi.api.base.{
  ScAccessModifier, ScModifierList
}
import org.jetbrains.plugins.scala.lang.psi.api.statements.params.{
  ScClassParameter, ScParameter
}
import org.jetbrains.plugins.scala.lang.psi.api.statements.{
  ScDeclaration, ScPatternDefinition, ScTypeAlias, ScValueDeclaration
}
    ...
    for (modifier <- ml.getNode.getChildren(null)) {
      ...
      modifierPsi match {
        case am: ScAccessModifier =>
          //todo: check private with final or sealed combination.
          if (am.isPrivate) {
          ...
          modifier.getText match {
            ...
            case "sealed" =>
              owner match {
                ...
                case _ =>
                  proccessError(ScalaBundle.message(
                                    "sealed.modifier.is.not.allowed.here"),
                                modifierPsi,
                                holder,
