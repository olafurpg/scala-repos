...
object TokenSets {
  ...
  val TMPL_OR_PACKAGING_DEF_BIT_SET = TokenSet.create(PACKAGING,
                                                      OBJECT_DEF,
                                                      CLASS_DEF,
                                                      TRAIT_DEF,
                                                      FUNCTION_DEFINITION,
  ...
  val SELF_TYPE_ID = TokenSet.create(ScalaTokenTypes.kTHIS,
  ...
  val VALUES = TokenSet.create(ScalaElementTypes.VALUE_DECLARATION,
