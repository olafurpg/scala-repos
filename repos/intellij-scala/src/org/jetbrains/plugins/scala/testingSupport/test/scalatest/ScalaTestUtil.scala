...
object ScalaTestUtil {
  ...
  def getFeatureSpecBases: List[String] =
    List("org.scalatest.FeatureSpec",
  ...
  def getFreeSpecBases: List[String] =
    List("org.scalatest.FreeSpec",
  ...
  def getJUnit3SuiteBases: List[String] =
  ...
  def getFunSpecBasesPre2_0: List[String] =
    List("org.scalatest.Spec",
  ...
  def getFunSpecBasesPost2_0: List[String] =
    List("org.scalatest.FunSpec",
  ...
  def getTestNGSuiteBases: List[String] =
    List("org.scalatest.testng.TestNGSuite",
         "org.scalatest.testng.TestNGSuiteLike")

  def getFlatSpecBases: List[String] =
    List("org.scalatest.FlatSpec",
  ...
  def getWordSpecBases: List[String] =
    List("org.scalatest.WordSpec",
