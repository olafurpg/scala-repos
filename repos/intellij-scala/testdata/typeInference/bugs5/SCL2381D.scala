object MethodSpecificity {
  ...
  object simple {
    implicit def m1(
        f: Int => Int): MA[PartialApply1Of2[Function1, Int]#Apply, Int] =
      new MA[PartialApply1Of2[Function1, Int]#Apply, Int]("Function1")
  ...
  object param1 {
    implicit def m1[A](
        f: Int => A): MA[PartialApply1Of2[Function1, Int]#Apply, A] =
      new MA[PartialApply1Of2[Function1, Int]#Apply, A]("Function1")
  ...
  object param2 {
    implicit def m1[I, A](
        f: I => A): MA[PartialApply1Of2[Function1, I]#Apply, A] =
      new MA[PartialApply1Of2[Function1, I]#Apply, A]("Function1")
    implicit def m2[A](l: Seq[A]): MA[Seq, A] = new MA[Seq, A]("Seq")
  ...
  /*start*/
  (simple.x, param1.x, param2.x, param3.x) /*end*/
}
