...
object Database {
  ...
  private lazy val databaseHM = HashMap[String, (Double, Double, String)](
      ...
      ("""nuclear magneton in eV/T""",
       (3.1524512605E-8, 2.2E-17, """eV T^-1""")),
      ...
      ("""proton molar mass""",
       (0.0010072764668120, 9.0E-14, """kg mol^-1""")),
