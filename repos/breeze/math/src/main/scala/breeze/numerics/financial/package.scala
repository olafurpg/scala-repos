...
package object financial {
  ...
  def principalInterest(rate: Double,
                        numPeriods: Int,
                        presentValue: Double,
                        futureValue: Double = 0.0,
  ...
  def interestPayments(rate: Double,
                       numPeriods: Int,
                       presentValue: Double,
                       futureValue: Double = 0.0,
  ...
  def principalPayments(rate: Double,
                        numPeriods: Int,
                        presentValue: Double,
                        futureValue: Double = 0.0,
                        when: PaymentTime = End): DenseVector[Double] =
  ...
  def principalRemaining(rate: Double,
                         numPeriods: Int,
                         presentValue: Double,
                         futureValue: Double = 0.0,
                         when: PaymentTime = End): DenseVector[Double] =
  ...
  def modifiedInternalRateReturn(values: DenseVector[Double],
                                 financeRate: Double,
  ...
  def numberPeriodicPayments(rate: Double,
                             pmt: Double,
                             pv: Double,
                             fv: Double = 0.0,
                             when: PaymentTime = End) = {
  ...
  def ratePeriodicPayments(nper: Double,
                           pmt: Double,
                           pv: Double,
                           fv: Double,
                           when: PaymentTime = End,
  ...
  //f(annuity)/f'(annuity)
  private def annuityFDivGradf(nper: Double,
                               pmt: Double,
                               pv: Double,
                               fv: Double,
                               when: PaymentTime,
