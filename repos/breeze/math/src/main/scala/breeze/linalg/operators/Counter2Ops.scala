...
trait Counter2Ops {
  implicit def canCopy[K1, K2, V : Zero : Semiring]: CanCopy[Counter2[
          K1, K2, V]] = new CanCopy[Counter2[K1, K2, V]] {
  ...
  implicit def addIntoVV[K1, K2, V : Semiring]: OpAdd.InPlaceImpl2[
      Counter2[K1, K2, V], Counter2[K1, K2, V]] = {
  ...
  implicit def canAxpy[K1, K2, V : Semiring]: scaleAdd.InPlaceImpl3[
      Counter2[K1, K2, V], V, Counter2[K1, K2, V]] = {
  ...
  implicit def addIntoVS[
      K1, K2, V : Semiring]: OpAdd.InPlaceImpl2[Counter2[K1, K2, V], V] =
  ...
  implicit def addVS[K1, K2, V : Semiring : Zero]: OpAdd.Impl2[
      Counter2[K1, K2, V], V, Counter2[K1, K2, V]] = {
    binaryOpFromBinaryUpdateOp(canCopy, addIntoVS)
  }

  implicit def subIntoVV[K1, K2, V : Ring]: OpSub.InPlaceImpl2[
      Counter2[K1, K2, V], Counter2[K1, K2, V]] =
  ...
  implicit def subIntoVS[
      K1, K2, V : Ring]: OpSub.InPlaceImpl2[Counter2[K1, K2, V], V] =
  ...
  implicit def subVS[K1, K2, V : Ring : Zero]: OpSub.Impl2[
      Counter2[K1, K2, V], V, Counter2[K1, K2, V]] = {
    binaryOpFromBinaryUpdateOp(canCopy, subIntoVS)
  }

  implicit def canMulIntoVV[K1, K2, V : Semiring]: OpMulScalar.InPlaceImpl2[
      Counter2[K1, K2, V], Counter2[K1, K2, V]] =
  ...
  implicit def canMulIntoVS[
      K1, K2, V : Semiring]: OpMulScalar.InPlaceImpl2[Counter2[K1, K2, V], V] =
  ...
  implicit def canMulIntoVS_M[
      K1, K2, V : Semiring]: OpMulMatrix.InPlaceImpl2[Counter2[K1, K2, V], V] =
  ...
  implicit def canDivIntoVV[K1, K2, V : Field]: OpDiv.InPlaceImpl2[
      Counter2[K1, K2, V], Counter2[K1, K2, V]] = {
  ...
  implicit def canDivIntoVS[
      K1, K2, V : Field]: OpDiv.InPlaceImpl2[Counter2[K1, K2, V], V] =
  ...
  implicit def canSetIntoVV[K1, K2, V]: OpSet.InPlaceImpl2[
      Counter2[K1, K2, V], Counter2[K1, K2, V]] =
  ...
  implicit def canSetIntoVS[
      K1, K2, V]: OpSet.InPlaceImpl2[Counter2[K1, K2, V], V] =
