...
class QuadraticMinimizerTest extends OptimizeTestBase with Matchers {
  ...
  test("Randomly generated matrix vector solve") {
    ...
    val q = DenseVector(0.14678, 0.32895, 0.71402)
    val x = H \ q
  ...
  test("Unconstrained Quadratic Minimization compared to BFGS") {
    ...
    val bfgsResult = optimizeWithLBFGS(init)
  ...
  test(
    ...
    val golden = DenseVector(0.3131862265452959,
                             0.0,
                             0.01129486116330884,
                             0.0,
                             0.0,
  ...
  test(
    ...
    val directQpMl = QuadraticMinimizer(ml, PROBABILITYSIMPLEX)
    val directQpResult = directQpMl.minimizeAndReturnState(Hml, fml)
  ...
  test(
    ...
    val octaveL1 = DenseVector(0.18611,
                               0.00000,
                               0.06317,
                               -0.10417,
                               0.11262,
  ...
  test(
    ...
    //NNLS test
    val P2 = new DenseMatrix[Double](20,
                                     20,
                                     Array(
                                       333907.312770,
                                       -60814.043975,
    ...
    val P3 = new DenseMatrix[Double](25,
                                     25,
                                     Array(
                                       0.986619,
                                       0.639909,
    ...
    val qpObj = QuadraticMinimizer.computeObjective(P1, q1, qpItersResult.x)
    val nnlsObj = NNLS.computeObjectiveValue(P1, q1 :* (-1.0), nnlsResult)
  ...
  test(
    ...
    val qpSolverPosTest = QuadraticMinimizer(n, POSITIVE, 0.0)
    val upper = upperTriangular(ata).data.filter(x => abs(x) > 0.0)
