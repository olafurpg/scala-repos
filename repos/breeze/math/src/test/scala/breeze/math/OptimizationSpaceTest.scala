...
class DenseOptimizationSpaceTest_Double
  ...
  val N = 30
  override implicit def genTripleM: Arbitrary[(DenseMatrix[Double],
                                               DenseMatrix[Double],
                                               DenseMatrix[Double])] = {
    Arbitrary {
      for {
...
class SparseOptimizationSpaceTest_Double
  ...
  override implicit def genTripleM: Arbitrary[(CSCMatrix[Double],
                                               CSCMatrix[Double],
                                               CSCMatrix[Double])] = {
    Arbitrary {
  ...
  override implicit def genTriple: Arbitrary[(SparseVector[Double],
                                              SparseVector[Double],
                                              SparseVector[Double])] = {
    Arbitrary {
      for {
