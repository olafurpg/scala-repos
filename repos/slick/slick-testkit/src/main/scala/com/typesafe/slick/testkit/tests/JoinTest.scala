...
class JoinTest extends AsyncTest[RelationalTestDB] {
  ...
  def testOptionExtendedJoin = {
    class Data(name: String)(tag: Tag)
        extends Table[(Int, String)](tag, name) {
      def a = column[Int]("a")
    ...
    for {
      ...
      _ = r3 shouldBe Set(((3, "b"), Some((3, "b"))),
                          ((3, "b"), Some((2, "b"))),
                          ((5, "c"), None),
                          ((1, "a"), Some((1, "a"))),
                          ((4, "c"), None),
      ...
      q5 = ((((xs joinLeft ys).on(_.b === _.b)) joinLeft ys)
        .on(_._1.b === _.b))
        .to[Set]
      ...
      // (left-associative; not symmetrical to the nested left outer case)
      q10 = ((((ys joinRight xs).on(_.b === _.b)) joinRight xs)
        .on(_._1.map(_.b) === _.b))
        .to[Set]
      ...
      _ = r11 shouldBe Set((Some("a"), Some("a")),
                           (Some("b"), Some("b")),
                           (Some("c"), None),
                           (None, Some("d")))
