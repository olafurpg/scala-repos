...
package object driver {
  ...
  @deprecated(
    "Use object `slick.jdbc.DerbyProfile` instead of `slick.driver.DerbyDriver`",
    "3.2")
  val DerbyDriver = slick.jdbc.DerbyProfile

  @deprecated(
    "Use type `slick.jdbc.H2Profile` instead of `slick.driver.H2Driver`",
    "3.2")
  ...
  @deprecated(
    "Use type `slick.jdbc.HsqldbProfile` instead of `slick.driver.HsqldbDriver`",
    "3.2")
  type HsqldbDriver = slick.jdbc.HsqldbProfile
  @deprecated(
    "Use object `slick.jdbc.HsqldbProfile` instead of `slick.driver.HsqldbDriver`",
    "3.2")
  val HsqldbDriver = slick.jdbc.HsqldbProfile

  @deprecated(
    "Use type `slick.jdbc.MySQLProfile` instead of `slick.driver.MySQLDriver`",
    "3.2")
  type MySQLDriver = slick.jdbc.MySQLProfile
  @deprecated(
    "Use object `slick.jdbc.MySQLProfile` instead of `slick.driver.MySQLDriver`",
    "3.2")
  val MySQLDriver = slick.jdbc.MySQLProfile

  @deprecated(
    "Use type `slick.jdbc.PostgresProfile` instead of `slick.driver.PostgresDriver`",
    "3.2")
  type PostgresDriver = slick.jdbc.PostgresProfile
  @deprecated(
    "Use object `slick.jdbc.PostgresProfile` instead of `slick.driver.PostgresDriver`",
    "3.2")
  val PostgresDriver = slick.jdbc.PostgresProfile

  @deprecated(
    "Use type `slick.jdbc.SQLiteProfile` instead of `slick.driver.SQLiteDriver`",
    "3.2")
