...
abstract class MethodDirectives extends HostDirectives {
  ...
  @varargs
  def get(innerRoute: Route, moreInnerRoutes: Route*): Route =
    method(HttpMethods.GET, innerRoute, moreInnerRoutes: _*)

  /** Handles the inner routes if the incoming request is a POST request, rejects the request otherwise */
  @varargs
  def post(innerRoute: Route, moreInnerRoutes: Route*): Route =
    method(HttpMethods.POST, innerRoute, moreInnerRoutes: _*)

  /** Handles the inner routes if the incoming request is a PUT request, rejects the request otherwise */
  @varargs
  def put(innerRoute: Route, moreInnerRoutes: Route*): Route =
    method(HttpMethods.PUT, innerRoute, moreInnerRoutes: _*)
  ...
  def delete(innerRoute: Route, moreInnerRoutes: Route*): Route =
    method(HttpMethods.DELETE, innerRoute, moreInnerRoutes: _*)

  /** Handles the inner routes if the incoming request is a HEAD request, rejects the request otherwise */
  @varargs
  def head(innerRoute: Route, moreInnerRoutes: Route*): Route =
    method(HttpMethods.HEAD, innerRoute, moreInnerRoutes: _*)

  /** Handles the inner routes if the incoming request is a OPTIONS request, rejects the request otherwise */
  @varargs
  def options(innerRoute: Route, moreInnerRoutes: Route*): Route =
    method(HttpMethods.OPTIONS, innerRoute, moreInnerRoutes: _*)

  /** Handles the inner routes if the incoming request is a PATCH request, rejects the request otherwise */
  @varargs
  def patch(innerRoute: Route, moreInnerRoutes: Route*): Route =
    method(HttpMethods.PATCH, innerRoute, moreInnerRoutes: _*)
