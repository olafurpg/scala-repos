...
private[http] object RouteStructure {
  ...
  case class RouteAlternatives()(val innerRoute: Route,
                                 val moreInnerRoutes: immutable.Seq[Route])
  ...
  abstract case class FileAndResourceRouteWithDefaultResolver(
      ...
      extends Route
  case class GetFromResource(resourcePath: String,
  ...
  case class GetFromDirectory(directory: File,
                              browseable: Boolean,
                              resolver: ContentTypeResolver)
      extends Route
  ...
  abstract class DynamicDirectiveRoute2[T1, T2](val value1: RequestVal[T1],
                                                val value2: RequestVal[T2])(
      val innerRoute: Route,
      val moreInnerRoutes: immutable.Seq[Route])
      extends Route {
  ...
  abstract class GenericHostFilter(val innerRoute: Route,
                                   val moreInnerRoutes: immutable.Seq[Route])
      extends HostFilter
  ...
  case class RangeSupport()(val innerRoute: Route,
                            val moreInnerRoutes: immutable.Seq[Route])
      extends DirectiveRoute
  ...
  case class SetCookie(cookie: HttpCookie)(
      ...
      val moreInnerRoutes: immutable.Seq[Route])
      extends DirectiveRoute
  case class DeleteCookie(name: String,
