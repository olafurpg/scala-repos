...
private[netty] trait NettyHelpers {
  ...
  protected def onConnect(ctx: ChannelHandlerContext,
                          e: ChannelStateEvent): Unit = ()

  protected def onDisconnect(ctx: ChannelHandlerContext,
                             e: ChannelStateEvent): Unit = ()

  protected def onOpen(ctx: ChannelHandlerContext,
                       e: ChannelStateEvent): Unit = ()

  protected def onMessage(ctx: ChannelHandlerContext, e: MessageEvent): Unit =
    ()

  protected def onException(ctx: ChannelHandlerContext,
                            e: ExceptionEvent): Unit = ()

  final protected def transformException(ctx: ChannelHandlerContext,
...
private[netty] trait NettyServerHelpers
  ...
  final override def messageReceived(ctx: ChannelHandlerContext,
                                     e: MessageEvent): Unit = {
  ...
  final override def channelConnected(ctx: ChannelHandlerContext,
                                      e: ChannelStateEvent): Unit = {
    super.channelConnected(ctx, e)
    onConnect(ctx, e)
  }

  final override def channelOpen(ctx: ChannelHandlerContext,
                                 e: ChannelStateEvent): Unit = {
    super.channelOpen(ctx, e)
    onOpen(ctx, e)
  }

  final override def channelDisconnected(ctx: ChannelHandlerContext,
                                         e: ChannelStateEvent): Unit = {
